...
**Status:** 🟢 Active ▸ Phases A + B + C + D.\* + E + F.0 + F + F.1 done · 133 / 133 .latte · `smarty/smarty` removed; `Template`'s handle-based API replaced with direct `.latte`-path calls · F.2 (rename `Template` → `PageRenderer`) is the only remaining cleanup · **Effort:** XL · depends on Wave 1
...
| F.2              | Rename `Template` → `PageRenderer` now that it's a pure page-coordinator                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | 🟡 Not started · cosmetic; class file rename + ~150 import updates + `TemplateRegistry` follow-on rename decision. |
