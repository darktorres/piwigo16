...
| 3.1  | CSS design tokens + Stylelint | 🟢 **Active** ▸ 11 / 13 | M        | 2 live steps remaining (12, 15); step 5 + step 11 shipped (admin theme 9,521 → 1,706 lines)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| ~~11~~ | ~~Split `themes/admin/_base/theme.css`~~ ✅ 9,521 → 1,706 lines (−82%). 32 page-specific sections moved to their per-page `css/pages/*.css` files (which templates already loaded individually). 5 new page CSS files created (`tags.css`, `plugins.css`, `watermark.css`, `group_list.css`, `themes_standard_pages.css`) plus `css/features/selection-mode.css`. Remaining 1,706 lines: global base content (menubar, tabsheets, forms, notifications) + "See in gallery" + icons. Phase A split (`css/base/` files + `@import` list) is the final sub-step needed to close this item. |
