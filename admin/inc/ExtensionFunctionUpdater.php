...
trait ExtensionFunctionUpdater
{
    ...
    protected function update_function_calls(string $path): void
    {
        ...
        $function_map = [
            ...
            'get_pwg_charset' => '\Piwigo\inc\functions::get_pwg_charset',
            ...
            // Database functions
            'boolean_to_string' => '\Piwigo\inc\dblayer\functions_mysqli::boolean_to_string',
            'do_maintenance_all_tables' => '\Piwigo\inc\dblayer\functions_mysqli::do_maintenance_all_tables',
            'get_boolean' => '\Piwigo\inc\dblayer\functions_mysqli::get_boolean',
            'get_enums' => '\Piwigo\inc\dblayer\functions_mysqli::get_enums',
            ...
            'pwg_db_check_version' => '\Piwigo\inc\dblayer\functions_mysqli::pwg_db_check_version',
            'pwg_db_close' => '\Piwigo\inc\dblayer\functions_mysqli::pwg_db_close',
            'pwg_db_concat_ws' => '\Piwigo\inc\dblayer\functions_mysqli::pwg_db_concat_ws',
            'pwg_db_concat' => '\Piwigo\inc\dblayer\functions_mysqli::pwg_db_concat',
            'pwg_db_connect' => '\Piwigo\inc\dblayer\functions_mysqli::pwg_db_connect',
            'pwg_db_date_to_ts' => '\Piwigo\inc\dblayer\functions_mysqli::pwg_db_date_to_ts',
            'pwg_db_errno' => '\Piwigo\inc\dblayer\functions_mysqli::pwg_db_errno',
            'pwg_db_error' => '\Piwigo\inc\dblayer\functions_mysqli::pwg_db_error',
            'pwg_db_fetch_assoc' => '\Piwigo\inc\dblayer\functions_mysqli::pwg_db_fetch_assoc',
            'pwg_db_fetch_object' => '\Piwigo\inc\dblayer\functions_mysqli::pwg_db_fetch_object',
            'pwg_db_fetch_row' => '\Piwigo\inc\dblayer\functions_mysqli::pwg_db_fetch_row',
            'pwg_db_free_result' => '\Piwigo\inc\dblayer\functions_mysqli::pwg_db_free_result',
            'pwg_db_get_date_MMDD' => '\Piwigo\inc\dblayer\functions_mysqli::pwg_db_get_date_MMDD',
            'pwg_db_get_date_YYYYMM' => '\Piwigo\inc\dblayer\functions_mysqli::pwg_db_get_date_YYYYMM',
            'pwg_db_get_dayofmonth' => '\Piwigo\inc\dblayer\functions_mysqli::pwg_db_get_dayofmonth',
            'pwg_db_get_dayofweek' => '\Piwigo\inc\dblayer\functions_mysqli::pwg_db_get_dayofweek',
            'pwg_db_get_flood_period_expression' => '\Piwigo\inc\dblayer\functions_mysqli::pwg_db_get_flood_period_expression',
            'pwg_db_get_hour' => '\Piwigo\inc\dblayer\functions_mysqli::pwg_db_get_hour',
            'pwg_db_get_month' => '\Piwigo\inc\dblayer\functions_mysqli::pwg_db_get_month',
            'pwg_db_get_recent_period_expression' => '\Piwigo\inc\dblayer\functions_mysqli::pwg_db_get_recent_period_expression',
            'pwg_db_get_recent_period' => '\Piwigo\inc\dblayer\functions_mysqli::pwg_db_get_recent_period',
            'pwg_db_get_week' => '\Piwigo\inc\dblayer\functions_mysqli::pwg_db_get_week',
            'pwg_db_get_weekday' => '\Piwigo\inc\dblayer\functions_mysqli::pwg_db_get_weekday',
            'pwg_db_get_year' => '\Piwigo\inc\dblayer\functions_mysqli::pwg_db_get_year',
            'pwg_db_insert_id' => '\Piwigo\inc\dblayer\functions_mysqli::pwg_db_insert_id',
            'pwg_db_nextval' => '\Piwigo\inc\dblayer\functions_mysqli::pwg_db_nextval',
            'pwg_db_num_rows' => '\Piwigo\inc\dblayer\functions_mysqli::pwg_db_num_rows',
            'pwg_db_real_escape_string' => '\Piwigo\inc\dblayer\functions_mysqli::pwg_db_real_escape_string',
            'pwg_get_db_version' => '\Piwigo\inc\dblayer\functions_mysqli::pwg_get_db_version',
            'pwg_query' => '\Piwigo\inc\dblayer\functions_mysqli::pwg_query',
            'query2array' => '\Piwigo\inc\dblayer\functions_mysqli::query2array',
            'single_insert' => '\Piwigo\inc\dblayer\functions_mysqli::single_insert',
            'single_update' => '\Piwigo\inc\dblayer\functions_mysqli::single_update',
