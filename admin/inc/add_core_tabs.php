...
function add_core_tabs($sheets, $tab_id)
{
    ...
    switch ($tab_id) {
        case 'admin_home':
            $sheets[''] = [
                'caption' => functions::l10n('Administration Home'),
                'url' => 'admin.php',
            ];
            break;
        ...
        case 'album':
            ...
            $sheets['properties'] = [
                'caption' => '<span class="icon-pencil"></span>' . functions::l10n('Properties'),
                'url' => $admin_album_base_url . '-properties',
            ];
            $sheets['sort_order'] = [
                'caption' => '<span class="icon-shuffle"></span>' . functions::l10n('Manage photo ranks'),
                'url' => $admin_album_base_url . '-sort_order',
            ];
            $sheets['permissions'] = [
                'caption' => '<span class="icon-lock"></span>' . functions::l10n('Permissions'),
                'url' => $admin_album_base_url . '-permissions',
            ];
            $sheets['notification'] = [
                'caption' => '<span class="icon-mail-alt"></span>' . functions::l10n('Notification'),
        ...
        case 'albums':
            ...
            $sheets['permalinks'] = [
                'caption' => '<span class="icon-link-1"></span>' . functions::l10n('Permalinks'),
                'url' => $my_base_url . 'permalinks',
            ];
            $sheets['search'] = [
                'caption' => '<span class="icon-search"></span>' . functions::l10n('Search'),
        ...
        case 'users':
            ...
            $sheets['user_activity'] = [
                'caption' => '<span class="icon-pulse"></span>' . functions::l10n('Activity'),
        ...
        case 'batch_manager':
            global $manager_link;
            $sheets['global'] = [
                'caption' => '<span class="icon-th"></span>' . functions::l10n('global mode'),
                'url' => $manager_link . 'global',
            ];
            $sheets['unit'] = [
                'caption' => '<span class="icon-th-list"></span>' . functions::l10n('unit mode'),
        ...
        case 'cat_options':
            global $link_start;
            $sheets['status'] = [
                'caption' => '<span class="icon-lock"></span>' . functions::l10n('Public / Private'),
        ...
        case 'users':
            global $my_base_url;
            $sheets[''] = [
                'caption' => '<span class="icon-users"> </span>' . functions::l10n('User list'),
                'url' => $my_base_url . 'user_list',
            ];
            break;
        ...
        case 'configuration':
            global $conf_link;
            $sheets['main'] = [
                'caption' => functions::l10n('General'),
                'url' => $conf_link . 'main',
            ];
            $sheets['sizes'] = [
                'caption' => functions::l10n('Photo sizes'),
                'url' => $conf_link . 'sizes',
            ];
            $sheets['watermark'] = [
                'caption' => functions::l10n('Watermark'),
                'url' => $conf_link . 'watermark',
            ];
            $sheets['display'] = [
                'caption' => functions::l10n('Display'),
                'url' => $conf_link . 'display',
            ];
            $sheets['comments'] = [
                'caption' => functions::l10n('Comments'),
        ...
        case 'help':
            global $help_link;
            $sheets['add_photos'] = [
                'caption' => functions::l10n('Add Photos'),
                'url' => $help_link . 'add_photos',
            ];
            $sheets['permissions'] = [
                'caption' => functions::l10n('Permissions'),
                'url' => $help_link . 'permissions',
            ];
            $sheets['groups'] = [
                'caption' => functions::l10n('Groups'),
                'url' => $help_link . 'groups',
            ];
            $sheets['virtual_links'] = [
                'caption' => functions::l10n('Virtual Links'),
                'url' => $help_link . 'virtual_links',
            ];
            $sheets['misc'] = [
                'caption' => functions::l10n('Miscellaneous'),
                'url' => $help_link . 'misc',
            ];
            break;
        ...
        case 'history':
            global $link_start;
            $sheets['stats'] = [
                'caption' => '<span class="icon-signal"></span>' . functions::l10n('Statistics'),
        ...
        case 'languages':
            ...
            if ($conf['enable_extensions_install']) {
                ...
                $sheets['new'] = [
                    'caption' => '<span class="icon-plus-circled"></span>' . functions::l10n('Add New Language'),
        ...
        case 'photo':
            ...
            $sheets['properties'] = [
                'caption' => '<span class="icon-file-image"></span>' . functions::l10n('Properties'),
        ...
        case 'photos_add':
            $sheets['direct'] = [
                'caption' => '<span class="icon-upload"></span>' . functions::l10n('Web Form'),
        ...
        case 'plugins':
            ...
            if ($conf['enable_extensions_install']) {
                ...
                $sheets['new'] = [
                    'caption' => '<span class="icon-plus-circled"></span>' . functions::l10n('Add New Plugin'),
                    'url' => $my_base_url . '&amp;tab=new',
                ];
            }
        ...
        case 'rating':
            $sheets['rating'] = [
                'caption' => functions::l10n('Photos'),
                'url' => functions_url::get_root_url() . 'admin.php?page=rating',
            ];
            $sheets['rating_user'] = [
                'caption' => functions::l10n('Users'),
                'url' => functions_url::get_root_url() . 'admin.php?page=rating_user',
            ];
            break;
        ...
        case 'themes':
            ...
            if ($conf['enable_extensions_install']) {
                ...
                $sheets['new'] = [
                    'caption' => '<span class="icon-plus-circled"></span>' . functions::l10n('Add New Theme'),
                    'url' => $my_base_url . '&amp;tab=new',
                ];
            }
        ...
        case 'site_update':
            ...
            $sheets['synchronization'] = [
                'caption' => '<span class="icon-exchange"></span>' . functions::l10n('Synchronization'),
                'url' => $my_base_url . 'site_update&site=1',
            ];
            $sheets['site_manager'] = [
                'caption' => '<span class="icon-flow-branch"></span>' . functions::l10n('Site manager'),
        ...
        case 'maintenance':
            global $my_base_url;
            $sheets['actions'] = [
                'caption' => '<span class="icon-tools"></span>' . functions::l10n('Actions'),
                'url' => $my_base_url . 'maintenance&tab=actions',
            ];
            $sheets['env'] = [
                'caption' => '<span class="icon-television"></span>' . functions::l10n('Environment'),
