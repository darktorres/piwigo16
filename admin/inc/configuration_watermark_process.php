    ...
    foreach (ImageStdParams::get_defined_type_map() as $type => $params) {
        ...
        if (! $changed &&
            ...
            $changed |= $watermark->min_size[0] != $old_watermark->min_size[0] &&
                                                  ($watermark->min_size[0] < $params->max_width() || $old_watermark->min_size[0] < $params->max_width());

            $changed |= $watermark->min_size[1] != $old_watermark->min_size[1] &&
                                                  ($watermark->min_size[1] < $params->max_height() || $old_watermark->min_size[1] < $params->max_height());
        }
