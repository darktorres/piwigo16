...
class functions_install
{
   ...
   */
  static function execute_sqlfile($filepath, $replaced, $replacing, $dblayer)
  {
   ...
   */
  static function activate_core_themes()
  {
    $themes = new themes();
   ...
   */
  static function activate_core_plugins()
  {
    $plugins = new plugins();
  ...
  static function install_db_connect(&$infos, &$errors)
  {
    try
    {
      functions_mysqli::pwg_db_connect($_POST['dbhost'], $_POST['dbuser'],
