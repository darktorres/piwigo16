...
class functions_metadata_admin
{
   ...
   * @return array
   */
  static function get_sync_iptc_data($file)
  {
    global $conf;
   ...
   * @return array
   */
  static function get_sync_exif_data($file)
  {
    global $conf;
   ...
   * @return string[]
   */
  static function get_sync_metadata_attributes()
  {
    global $conf;
   ...
   */
  static function get_sync_metadata($infos)
  {
    global $conf;
   ...
   * @param int[] $ids
   */
  static function sync_metadata($ids)
  {
    global $conf;
   ...
   * @return string
   */
  static function metadata_normalize_keywords_string($keywords_string)
  {
    global $conf;
