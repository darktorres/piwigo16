...
class functions_notification_by_mail
{
  ...
  */
  ...
  static function assign_vars_nbm_mail_content($nbm_user)
  {
    global $env_nbm;
    ...
    (
      ...
      (
        ...
        'UNSUBSCRIBE_LINK' => functions_url::add_url_params(functions_url::get_gallery_home_url().'/nbm.php', array('unsubscribe' => $nbm_user['check_key'])),
        'SUBSCRIBE_LINK' => functions_url::add_url_params(functions_url::get_gallery_home_url().'/nbm.php', array('subscribe' => $nbm_user['check_key'])),
