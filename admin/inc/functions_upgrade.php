...
class functions_upgrade
{
  ...
  static function deactivate_non_standard_plugins()
  {
    global $page;
  ...
  static function deactivate_non_standard_themes()
  {
    global $page, $conf;
  ...
  // Check access rights
  static function check_upgrade_access_rights()
  {
   ...
   * @return array
   */
  static function get_available_upgrade_ids()
  {
   ...
   */
  static function check_upgrade_feed()
  {
  ...
  static function upgrade_db_connect()
  {
    global $conf;
