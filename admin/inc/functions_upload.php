...
{
  static function get_upload_form_config()
  {
  ...
  static function save_upload_form_config($data, &$errors=array(), &$form_errors=array())
  {
  ...
  static function add_uploaded_file($source_filepath, $original_filename=null, $categories=null, $level=null, $image_id=null, $original_md5sum=null)
  {
  ...
  static function add_uploaded_file_add_to_categories($image_id, $categories)
  {
    global $conf;
  ...
  static function add_format($source_filepath, $format_ext, $format_of)
  {
  ...
  static function upload_file_pdf($representative_ext, $file_path)
  {
    global $logger, $conf;
  ...
  static function upload_file_heic($representative_ext, $file_path)
  {
    global $logger, $conf;
  ...
  static function upload_file_tiff($representative_ext, $file_path)
  {
    global $logger, $conf;
  ...
  static function upload_file_psd($representative_ext, $file_path)
  {
    global $logger, $conf;
  ...
  static function prepare_directory($directory)
  {
    if (!is_dir($directory)) {
  ...
  static function pwg_image_infos($path)
  {
  ...
  static function is_valid_image_extension($extension)
  {
    global $conf;
  ...
  static function file_upload_error_message($error_code)
  {
    switch ($error_code) {
  ...
  static function get_ini_size($ini_key, $in_bytes=true)
  {
  ...
  static function convert_shorthand_notation_to_bytes($value)
  {
  ...
  static function add_upload_error($upload_id, $error_message)
  {
    $_SESSION['uploads_error'][$upload_id][] = $error_message;
  }

  static function ready_for_upload_message()
  {
    global $conf;
