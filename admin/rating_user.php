...
$available_order_by = [
    [functions::l10n('Average rate'), functions_admin::avg_compare(...)],
    [functions::l10n('Number of rates'), functions_admin::count_compare(...)],
    [functions::l10n('Variation'), functions_admin::cv_compare(...)],
