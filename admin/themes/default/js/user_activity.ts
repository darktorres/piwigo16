...
declare var actionInfos_album_added: any;
declare var actionInfos_album_deleted: any;
declare var actionInfos_album_edited: any;
declare var actionInfos_album_moved: any;
declare var actionInfos_albums_added: any;
declare var actionInfos_albums_deleted: any;
declare var actionInfos_albums_edited: any;
declare var actionInfos_albums_moved: any;
declare var actionInfos_group_added: any;
declare var actionInfos_group_deleted: any;
declare var actionInfos_group_edited: any;
declare var actionInfos_group_moved: any;
declare var actionInfos_groups_added: any;
declare var actionInfos_groups_deleted: any;
declare var actionInfos_groups_edited: any;
declare var actionInfos_groups_moved: any;
declare var actionInfos_photo_added: any;
declare var actionInfos_photo_deleted: any;
declare var actionInfos_photo_edited: any;
declare var actionInfos_photo_moved: any;
declare var actionInfos_photos_added: any;
declare var actionInfos_photos_deleted: any;
declare var actionInfos_photos_edited: any;
declare var actionInfos_photos_moved: any;
declare var actionInfos_tag_added: any;
declare var actionInfos_tag_deleted: any;
declare var actionInfos_tag_edited: any;
declare var actionInfos_tag_moved: any;
declare var actionInfos_tags_added: any;
declare var actionInfos_tags_deleted: any;
declare var actionInfos_tags_edited: any;
declare var actionInfos_tags_moved: any;
declare var actionInfos_user_added: any;
declare var actionInfos_user_deleted: any;
declare var actionInfos_user_edited: any;
declare var actionInfos_user_logged_in: any;
declare var actionInfos_user_logged_out: any;
declare var actionInfos_users_added: any;
declare var actionInfos_users_deleted: any;
declare var actionInfos_users_edited: any;
declare var actionInfos_users_logged_in: any;
declare var actionInfos_users_logged_out: any;
declare var actionType_add: any;
declare var actionType_delete: any;
declare var actionType_edit: any;
declare var actionType_login: any;
declare var actionType_logout: any;
declare var actionType_move: any;
declare var action_filter: any;
declare var activity_page: any;
declare var actual_page: any;
declare var additional_filt_type: any;
declare var additional_filt_value: any;
declare var color_icons: any;
declare var current_page_offset: any;
declare var date_max: any;
declare var date_max_filter: any;
declare var date_min: any;
declare var date_min_filter: any;
declare var end_page: any;
declare var nb_users: any;
declare var object: any;
declare var object_filter: any;
declare var page_ellipsis: any;
declare var page_item: any;
declare var page_offsets: any;
declare var uid_filter: any;
declare var users_key: any;
...
function get_user_activity(page: any, uid: any, action: any, object: any, date: any, id: any) {
    ...
    $.ajax({
        ...
        beforeSend: () => {
          $('.tab').contents().filter(':not(#-1):not(.loading)').remove();
          $(".loading").show();
...
$(document).ready(function () {
    ...
    $('#date_min_activity').on('change', function(user) {
        ...
        {
            document.getElementById('date_max_activity')!.setAttribute('min', String($('#date_min_activity').val()));
        }
        get_user_activity(activity_page, uid_filter, action_filter, object_filter, [String($('#date_min_activity').val()), date_max_filter], additional_filt_value);
    })
    ...
    $('#date_max_activity').on('change', function(user) {
        ...
        {
            document.getElementById('date_min_activity')!.setAttribute('max', String($('#date_max_activity').val()));
        }
        get_user_activity(activity_page, uid_filter, action_filter, object_filter, [date_min_filter, String($('#date_max_activity').val())], additional_filt_value);
    })
