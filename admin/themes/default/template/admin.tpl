...
<div id="menubar">
  ...
  <dl>
    <dt><i class="icon-picture"> </i><span>{'Photos'|@translate}&nbsp;</span><i class="icon-down-open open-menu"></i>
    </dt>
    <dd>
      <ul>
  ...
  <dl>
    <dt><i class="icon-sitemap"> </i><span>{'Albums'|@translate}&nbsp;</span><i class="icon-down-open open-menu"></i>
    </dt>
    <dd>
      <ul>
  ...
  <dl>
    <dt><a href="{$U_PLUGINS}" class="admin-main"><i class="icon-puzzle">
        </i><span>{'Plugins'|@translate}&nbsp;</span></a></dt>
  </dl>
  <dl>
  ...
  <dl>
    <dt><i class="icon-cog"> </i><span>{'Configuration'|@translate}&nbsp;</span><i class="icon-down-open open-menu"></i>
    </dt>
    <dd>
      <ul>
