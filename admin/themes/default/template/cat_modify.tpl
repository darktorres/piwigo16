{combine_css path='admin/themes/default/css/pages/cat_modify.css' order=-10}
      ...
      {if isset($CAT_COMMENTABLE)}
        <div class="cat-modify-switch-container">
          <div class="switch-input">
            <label class="switch">
              <input type="checkbox" name="commentable" id="cat-commentable" value="true"
                {if $CAT_COMMENTABLE == "true"}checked{/if}>
  ...
  <div class="cat-modify-footer">
    <div class="cat-modify-footer-start">
      {if functions_admin::cat_admin_access($CAT_ID)}
        <a class="cat-modify-footer-see-out" href="{$U_JUMPTO}"><i
            class="icon-left-open"></i>{'Open in gallery'|translate}</a>
      {else}
        <a class="tiptip cat-modify-footer-see-out disabled" title="{'ACCESS_5'|translate}" href="#"><i
            class="icon-left-open"></i>{'Open in gallery'|translate}</a>
      {/if}
    </div>
    ...
    <div class="desc-modal-content">
      ...
      <div class="desc-modal-footer">
        <p id="desc-modal-close" class="cat-modify-footer-see-out"><span
            class="icon-resize-small"></span>{'Shrink'|translate}</p>
      </div>
    </div>
  </div>
</div>
