...
{/if}
  ...
  <div class="filterActions">
    <div id="addFilter">
      <div class="addFilter-button icon-plus" onclick="var el=document.querySelector('.addFilter-dropdown');if(el)el.style.display=getComputedStyle(el).display==='none'?'':'none'">{'Add a filter'|@translate}</div>
