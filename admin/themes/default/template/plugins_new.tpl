...
<script id="pwg-page-data" type="application/json">
{
  ...
  "str_cancel_msg": "{"No, I have chaged my mind"|translate|escape:'html'}",
  "str_install_title": "{'Are you sure you want to install the plugin "%s"?'|translate|escape:'html'}",
  "strs_certification": {
    "-1": "{'This plugin is incompatible with your version'|translate|escape:'html'}",
    "0": "{'This plugin have no update since 3 years ! It may be outdated'|translate|escape:'html'}",
    "1": "{'This plugin has no recent update'|translate|escape:'html'}",
    "2": "{'This plugin was updated less than 6 months ago'|translate|escape:'html'}",
    "3": "{'This plugin have been updated recently'|translate|escape:'html'}"
  },
  "str_x_month": "{"%d month"|translate|escape:'html'}",
  "str_x_months": "{"%d months"|translate|escape:'html'}",
  "str_x_year": "{"%d year"|translate|escape:'html'}",
  "str_x_years": "{"%d years"|translate|escape:'html'}",
  "str_from_beginning": "{"since the beginning"|translate|escape:'html'}"
}
</script>
...
<div class="titrePage">
  <div class="sort">
    <div class="sort-actions">
      <div class="beta-test-plugin-switch tiptip"
        title="{'Show plugins compatible with previous version of Piwigo'|translate|escape:html}">
        <label class="switch">
          ...
          <div class="pluginInfo">
            <div>
              <div class="pluginName">
                ...
                <i class="certification tiptip" data-certification={$plugin.CERTIFICATION} {if $plugin.CERTIFICATION == 3}
                  title="{'This plugin have been updated recently'|translate}" {elseif $plugin.CERTIFICATION == 2}
                  title="{'This plugin was updated less than 6 months ago'|translate}" {elseif $plugin.CERTIFICATION == 1}
                  title="{'This plugin has no recent update'|translate}" {elseif $plugin.CERTIFICATION == 0}
                    title="{'This plugin have no update since 3 years ! It may be outdated'|translate}"
                  {elseif $plugin.CERTIFICATION == -1} title="{'This plugin is incompatible with your version'|translate}"
                  {/if}></i>
              </div>
            ...
            <div>
              {if !is_null($plugin.RATING)}
                <div class="pluginRating tiptip" data-rating="{$plugin.RATING}"
                  title="{'On %d rating(s)'|translate:$plugin.NB_RATINGS}">
              ...
              {/if}
              <div class="pluginDownload tiptip" title="{$plugin.DOWNLOADS} {'Downloads'|translate}"><i
                  class="icon-download">{$plugin.DOWNLOADS}</i></div>
              <div class="pluginVersion tiptip" title="{$plugin.REVISION_FORMATED_DATE}"><i
                  class="icon-flow-branch"></i>{'Version %s'|translate:$plugin.VERSION}</div>
              <a class="pluginLink" href="{$plugin.EXT_URL}"><i class="icon-link"></i>{'Website'|translate}</a>
            </div>

            <div class="pluginInstall">
              <a class="buttonLike buttonInstall" href="{$plugin.URL_INSTALL}"><i
                  class="icon-plus-circled"></i>{'Add'|translate}</a>
            </div>
          </div>
