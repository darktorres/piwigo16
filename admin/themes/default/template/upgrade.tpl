{combine_css path='admin/themes/default/css/pages/install-upgrade.css' order=-10}
<!DOCTYPE html>
            ...
            {if isset($login)}
              <table>
                <tr>
                  ...
                  <td><input type="text" name="username" id="username" size="20" maxlength="50" style="width: 150px;"
