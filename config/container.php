...
return [
    ...
    HtmlService::class         => factory(static fn (Connection $conn, EventDispatcherInterface $d): HtmlService => new HtmlService($conn, $d)),
    ...
    AdminService::class              => factory(static fn (Connection $conn, CategoryRepository $catR, DateService $d, HistoryRepository $hR, ImageRepository $i, TagRepository $tR, UserRepository $u): AdminService => new AdminService($conn, $catR, $d, $hR, $i, $tR, $u)),
    ...
    NoPhotoYetRenderer::class        => factory(static fn (ConfigService $cfg, ImageRepository $i, UrlGenerator $ug, RedirectResponder $redirect, UrlService $us, PermissionService $perm, EventDispatcherInterface $dispatcher): NoPhotoYetRenderer => new NoPhotoYetRenderer($cfg, $i, $ug, $redirect, $us, $perm, $dispatcher)),
