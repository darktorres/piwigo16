...
return [
    ...
    FilterMiddleware::class           => factory(static fn (CategoryService $cat, ImageRepository $i, Session $session, SessionService $sess, FilterService $f): FilterMiddleware => new FilterMiddleware($cat, $i, $session, $sess, $f)),
