...
> **Status: closed (2026-05-15).** Replaced by service-owned state — the
> as-shipped record lives in git history (Wave A reference-bridge closure,
> see commits around 2026-05-15). This document describes a different
> approach (typed immutable VOs distributed via DI) that was superseded
> in §A1; kept for historical context.
