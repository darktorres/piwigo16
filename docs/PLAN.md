...
| P52 | CSS architecture modernization | In progress — Tailwind call resolved (not adopted); full design scoped below (P52-A through J); P52-A done (`.browserslistrc` floor bump), P52-B through J not started | 1 |
