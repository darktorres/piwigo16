...
11. ✅ **Validate the CI workflow.** Playwright suite is 9/9 green locally (1.3 min, 1 worker). Push `16.x-rewrite` and confirm the three GitHub Actions jobs (`lint`, `unit`, `e2e`) go green on this branch. From this moment forward, any red CI is a regression, not a setup gap.
