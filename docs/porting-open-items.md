...
- [ ] rv_tscroller — sequencing: land the `SectionPopulator` extraction as its own standalone commit first, or as the first commit of the plugin-port branch? Either works.
