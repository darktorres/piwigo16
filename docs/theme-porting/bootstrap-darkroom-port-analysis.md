...
- `themes/default/js/vendor/photoswipe.ts` (§5.8) as a shared lightbox capability, following `colorbox.ts`'s pattern — landed (deferred to Phase 6 in the real execution, per this file's own P61 status elsewhere).
