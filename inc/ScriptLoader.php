        ...
        do {
            ...
            foreach ($scripts as $id => $script) {
                ...
                foreach ($script->precedents as $precedent) {
                    ...
                    if ($load == 2 && $scripts[$precedent]->load_mode == 2 && ($scripts[$precedent]->is_remote() or ! $conf['template_combine_files'])) {// we are async -> a predecessor cannot be async unless it can be merged; otherwise script execution order is not guaranteed
