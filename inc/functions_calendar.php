...
class functions_calendar
{
   ...
   */
  static function initialize_calendar()
  {
  ...
  INNER JOIN '.IMAGE_CATEGORY_TABLE.' ON id = image_id';
      ...
      {
        $sub_ids = array_diff(
          functions_category::get_subcat_ids(array($page['category']['id'])),
  ...
  //-------------------------------------- initialize the calendar parameters ---
    ...
    $views = array(self::CAL_VIEW_LIST,self::CAL_VIEW_CALENDAR);
    ...
    if ( self::CAL_VIEW_CALENDAR==$page['chronology_view'] and
