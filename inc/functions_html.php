...
class functions_html
{
   ...
   * @return string
   */
  static function get_cat_display_name_cache($uppercats,
                                      $url = '',
                                      $single_link = false,
                                      $link_class = null,
                                      $auth_key=null)
   ...
   * @return string
   */
  static function get_cat_display_name_from_id($cat_id, $url = '')
  {
   ...
   * @return string
   */
  static function render_comment_content($content)
  {
   ...
   */
  static function name_compare($a, $b)
  {
   ...
   */
  static function tag_alpha_compare($a, $b)
  {
    global $cache;
  ...
  static function page_forbidden($msg, $alternate_url=null)
  {
    ...
    functions::redirect_html( $alternate_url,
   ...
   */
  static function fatal_error($msg, $title=null, $show_trace=true)
  {
    if (empty($title))
    {
   ...
   * @return string
   */
  static function get_tags_content_title()
  {
    global $page;
   ...
   * @return string
   */
  static function get_combined_categories_content_title()
  {
    global $page;
    ...
    foreach ($all_categories as $idx => $category)
    {
      ...
      $title.= self::get_cat_display_name(array($category));
   ...
   */
  static function set_status_header($code, $text='')
  {
    if (empty($text))
    {
      switch ($code)
   ...
   * @return string
   */
  static function render_category_literal_description($desc)
  {
   ...
   */
  static function register_default_menubar_blocks($menu_ref_arr)
  {
    $menu = & $menu_ref_arr[0];
   ...
   * @return string
   */
  static function render_element_name($info)
  {
    if (!empty($info['name']))
    {
   ...
   * @return string
   */
  static function render_element_description($info, $param='')
  {
   ...
   * @return string
   */
  static function get_thumbnail_title($info, $title, $comment='')
  {
    global $conf, $user;
   ...
   * @return string
   */
  static function get_src_image_url_protection_handler($url, $src_image)
  {
   ...
   * @return string
   */
  static function get_element_url_protection_handler($url, $infos)
  {
    global $conf;
   ...
   */
  static function flush_page_messages()
  {
