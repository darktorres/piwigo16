...
class functions_notification
{
   ...
   * @return string
   */
  static function get_std_sql_where_restrict_filter($prefix_condition,
                                            $img_field = 'ic.image_id',
                                            $force_one_condition = false)
  {
    return functions_user::get_sql_condition_FandF(
      array(
   ...
   */
  static function custom_notification_query($action, $type, $start=null, $end=null)
  {
    global $user;
   ...
   * @return int
   */
  static function nb_new_comments($start=null, $end=null)
  {
   ...
   */
  static function new_comments($start=null, $end=null)
  {
   ...
   * @return int
   */
  static function nb_unvalidated_comments($start=null, $end=null)
  {
   ...
   * @return int
   */
  static function nb_new_elements($start=null, $end=null)
  {
   ...
   */
  static function new_elements($start=null, $end=null)
  {
   ...
   * @return int
   */
  static function nb_updated_categories($start=null, $end=null)
  {
   ...
   */
  static function updated_categories($start=null, $end=null)
  {
   ...
   * @return int
   */
  static function nb_new_users($start=null, $end=null)
  {
   ...
   * @return int[] user ids
   */
  static function new_users($start=null, $end=null)
  {
  ...
  {
    return (
            (self::nb_new_comments($start, $end) > 0) or
   ...
   * @param bool $add_url
   */
  static function add_news_line(&$news, $count, $singular_key, $plural_key, $url='', $add_url=false)
  {
    if ($count > 0)
    {
   ...
   * @return array
   */
  static function news($start=null, $end=null, $exclude_img_cats=false, $add_url=false, $auth_key=null)
  {
    $news = array();
    ...
    if (!$exclude_img_cats)
    {
      self::add_news_line(
        ...
        '%d new photo',
        '%d new photos',
        functions_url::add_url_params(functions_url::make_index_url(array('section'=>'recent_pics')), $add_url_params),
        $add_url
        );
      ...
      self::add_news_line(
        ...
        '%d album updated',
        '%d albums updated',
        functions_url::add_url_params(functions_url::make_index_url(array('section'=>'recent_cats')), $add_url_params),
        $add_url
        );
    }
    ...
    self::add_news_line(
      ...
      '%d new comment',
      '%d new comments',
      functions_url::add_url_params(functions_url::get_root_url().'comments.php', $add_url_params),
      $add_url
      );

    if (functions_user::is_admin())
    {
      self::add_news_line( $news,
          self::nb_unvalidated_comments($start, $end), '%d comment to validate', '%d comments to validate',
          functions_url::get_root_url().'admin.php?page=comments', $add_url );

      self::add_news_line( $news,
          self::nb_new_users($start, $end), '%d new user', '%d new users',
          functions_url::get_root_url().'admin.php?page=user_list', $add_url );
    }
   ...
   * @return array
   */
  static function get_recent_post_dates($max_dates, $max_elements, $max_cats)
  {
   ...
   * @return array
   */
  static function get_recent_post_dates_array($args)
  {
   ...
   * @return string
   */
  static function get_html_description_recent_post_date($date_detail, $auth_key=null)
  {
    global $conf;
    ...
    $description .=
          '<li>'
          .functions::l10n_dec('%d new photo', '%d new photos', $date_detail['nb_elements'])
          .' ('
          .'<a href="'.functions_url::add_url_params(functions_url::make_index_url(array('section'=>'recent_pics')), $add_url_params).'">'
    ...
    $description .=
          '<li>'
          .functions::l10n_dec('%d album updated', '%d albums updated', $date_detail['nb_cats'])
          .'</li>';
    ...
    foreach($date_detail['categories'] as $cat)
    {
      $description .=
            '<li>'
            .functions_html::get_cat_display_name_cache($cat['uppercats'],'', false, null, $auth_key)
            .' ('.
   ...
   * @return string
   */
  static function get_title_recent_post_date($date_detail)
  {
    global $lang;

    $title = functions::l10n_dec('%d new photo', '%d new photos', $date_detail['nb_elements']);
