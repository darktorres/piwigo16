...
class functions_notification
{
     ...
     */
    public static function custom_notification_query($action, $type, $start = null, $end = null)
    {
        global $user;
     ...
     * @return array
     */
    public static function news($start = null, $end = null, $exclude_img_cats = false, $add_url = false, $auth_key = null)
    {
        $news = [];
  ...
  ;';
     ...
     * @return string
     */
    public static function get_html_description_recent_post_date($date_detail, $auth_key = null)
    {
        global $conf;
