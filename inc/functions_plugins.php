...
class functions_plugins
{
   ...
   */
  static function add_event_handler($event, $func,
   ...
   * @return mixed
   */
  static function &get_plugin_data($plugin_id)
  {
    global $pwg_loaded_plugins;
   ...
   * @return array
   */
  static function get_db_plugins($state='', $id='')
  {
    $query = '
   ...
   * @param string $plugin
   */
  static function load_plugin($plugin)
  {
  ...
  ;';
        ...
        functions::pwg_activity('system', ACTIVITY_SYSTEM_PLUGIN, 'autoupdate', array('plugin_id'=>$plugin['id'], 'from_version'=>$old_version, 'to_version'=>$new_version));
      }
    }
  }
