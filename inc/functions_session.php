...
class functions_session
{
   ...
   * @return true
   */
  static function pwg_session_close()
  {
    return true;
  }
   ...
   * @return string
   */
  static function get_remote_addr_session_hash()
  {
    global $conf;
   ...
   * @return string
   */
  static function pwg_session_read($session_id)
  {
    $query = '
  SELECT data
    FROM '.SESSIONS_TABLE.'
   ...
   * @return true
   */
  static function pwg_session_destroy($session_id)
  {
    $query = '
  DELETE
    FROM '.SESSIONS_TABLE.'
   ...
   * @return true
   */
  static function pwg_session_gc()
  {
    global $conf;
   ...
   * @return bool
   */
  static function pwg_set_session_var($var, $value)
  {
    if ( !isset($_SESSION) )
      return false;
   ...
   * @return mixed
   */
  static function pwg_get_session_var($var, $default = null)
  {
   ...
   * @return bool
   */
  static function pwg_unset_session_var($var)
  {
    if ( !isset($_SESSION) )
      return false;
   ...
   * @return null
   */
  static function delete_user_sessions($user_id)
  {
    $query = '
  DELETE
    FROM '.SESSIONS_TABLE.'
