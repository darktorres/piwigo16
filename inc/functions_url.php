...
class functions_url
{
      ...
      while (isset($tokens[$next_token]))
      {
        ...
        {// try a permalink
          ...
          if ( count($maybe_permalinks) )
          {
            ...
            {
              functions_html::page_not_found(functions::l10n('Permalink for album not found'));
            }
          }
        }
      }
      ...
      elseif (strpos($tokens[$i], 'created-')===0 or strpos($tokens[$i], 'posted-')===0)
      {
        ...
        if ( count($chronology_tokens)>0 )
        {
          ...
          foreach ($page['chronology_date'] as $date_token)
          {
            ...
            {
              functions_html::fatal_error('bad chronology field (date)');
            }
          }
        }
      }
  ...
  */
   ...
   */
  static function get_gallery_home_url()
  {
    global $conf;
