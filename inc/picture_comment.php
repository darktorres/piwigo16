...
if ( $page['show_comments'] and isset( $_POST['content'] ) )
{
  ...
  functions_plugins::trigger_notify( 'user_comment_insertion',
...
;';
  ...
  $navigation_bar = functions::create_navigation_bar(
    functions_url::duplicate_picture_url(array(), array('start')),
    $row['nb_comments'],
    $page['start'],
  ...
  if ($row['nb_comments'] > 0)
  {
    ...
    $template->assign(array(
      'COMMENTS_ORDER_URL' => functions_url::add_url_params( functions_url::duplicate_picture_url(), array('comments_order'=> ($comments_order == 'ASC' ? 'DESC' : 'ASC') ) ),
