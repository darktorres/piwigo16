...
class pwg_images
{
   ...
   */
  static function ws_add_image_category_relations($image_id, $categories_string, $replace_mode=false)
  {
   ...
   * @param string $type
   */
  static function merge_chunks($output_filepath, $original_sum, $type)
  {
    global $conf, $logger;
   ...
   * algorithm)
   */
  static function remove_chunks($original_sum, $type)
  {
    global $conf;
  ...
  ;';
    ...
    //-------------------------------------------------------------- related tags
    $related_tags = functions_tag::get_common_tags(array($image_row['id']), -1);
