...
function ws_addDefaultMethods(array $arr): void
{
    ...
    $service->register(new MethodDefinition(
        name:        'pwg.getVersion',
        callback:    'ws_getVersion',
        description: 'Returns the Piwigo version.',
        tags:        ['pwg'],
        includeFile: $ws_functions_root . 'pwg.php',
    ));

    $service->register(new MethodDefinition(
        name:         'pwg.getInfos',
        callback:     'ws_getInfos',
    ...
    $service->register(new MethodDefinition(
        ...
        callback:    'ws_categories_getImages',
...
<br><b>order</b> comma separated fields for sorting',
        ...
        tags:        ['categories'],
        includeFile: $ws_functions_root . 'pwg.categories.php',
    ));

    $service->register(new MethodDefinition(
        name:        'pwg.categories.getList',
        callback:    'ws_categories_getList',
    ...
    $service->register(new MethodDefinition(
        ...
        callback:     'ws_getMissingDerivatives',
    ...
    $service->register(new MethodDefinition(
        ...
        callback:     'ws_images_setPrivacyLevel',
    ...
    $service->register(new MethodDefinition(
        ...
        callback:     'ws_images_formats_searchImage',
    ...
    $service->register(new MethodDefinition(
        ...
        callback:     'ws_images_formats_delete',
...
<li>you are supposed to provide the list of all image_ids belonging to the album.
    ...
    $service->register(new MethodDefinition(
        ...
        callback:     'ws_images_setCategory',
    ...
    $service->register(new MethodDefinition(
        ...
        tags:        ['tags'],
        includeFile: $ws_functions_root . 'pwg.tags.php',
    ));

    $service->register(new MethodDefinition(
        name:        'pwg.tags.getImages',
        callback:    'ws_tags_getImages',
...
<br>Set the form encoding to "form-data".',
    ...
    $service->register(new MethodDefinition(
        ...
        callback:     'ws_images_uploadAsync',
...
<br>Requires <b>admin</b> credentials: either with username/password or header authorization with api key.',
    ...
    $service->register(new MethodDefinition(
        ...
        callback:     'ws_images_syncMetadata',
    ...
    $service->register(new MethodDefinition(
        ...
        callback:     'ws_images_deleteOrphans',
    ...
    $service->register(new MethodDefinition(
        ...
        callback:     'ws_categories_calculateOrphans',
    ...
    $service->register(new MethodDefinition(
        ...
        callback:     'ws_categories_getAdminList',
...
<br>Set parent as 0 to move to gallery root. Only virtual categories can be moved.',
    ...
    $service->register(new MethodDefinition(
        ...
        callback:     'ws_categories_setRepresentative',
    ...
    $service->register(new MethodDefinition(
        ...
        callback:     'ws_categories_deleteRepresentative',
    ...
    $service->register(new MethodDefinition(
        ...
        callback:     'ws_categories_refreshRepresentative',
...
<br>Don\'t use "thumbnail_sum" and "high_sum", these parameters are here for backward compatibility.',
    ...
    $service->register(new MethodDefinition(
        ...
        callback:     'ws_images_checkUpload',
    ...
    $service->register(new MethodDefinition(
        ...
        callback:     'ws_images_emptyLounge',
    ...
    $service->register(new MethodDefinition(
        ...
        callback:     'ws_images_uploadCompleted',
...
<br><b>pwg_token</b> required if you want to use HTML in name/comment/author.',
    ...
    $service->register(new MethodDefinition(
        ...
        callback:     'ws_categories_setInfo',
    ...
    $service->register(new MethodDefinition(
        ...
        callback:     'ws_categories_setRank',
    ...
    $service->register(new MethodDefinition(
        ...
        callback:     'ws_themes_performAction',
        params:       [
    ...
    $service->register(new MethodDefinition(
        ...
        callback:     'ws_extensions_ignoreupdate',
    ...
    $service->register(new MethodDefinition(
        ...
        callback:     'ws_extensions_checkupdates',
    ...
    $service->register(new MethodDefinition(
        ...
        tags:         ['groups'],
        requiresAuth: true,
        includeFile:  $ws_functions_root . 'pwg.groups.php',
    ));

    $service->register(new MethodDefinition(
        name:         'pwg.groups.add',
        callback:     'ws_groups_add',
...
<b>min_register</b> and <b>max_register</b> filter users by their registration date expecting format "YYYY" or "YYYY-mm" or "YYYY-mm-dd".',
        ...
        tags:         ['users'],
        requiresAuth: true,
        includeFile:  $ws_functions_root . 'pwg.users.php',
    ));

    $service->register(new MethodDefinition(
        name:         'pwg.users.add',
        callback:     'ws_users_add',
...
<br>set "group_id" to -1 if you want to dissociate users from all groups',
    ...
    $service->register(new MethodDefinition(
        ...
        callback:     'ws_permissions_getList',
...
<br>Provide only one parameter!',
        ...
        tags:         ['permissions'],
        requiresAuth: true,
        includeFile:  $ws_functions_root . 'pwg.permissions.php',
    ));

    $service->register(new MethodDefinition(
        name:         'pwg.permissions.add',
        callback:     'ws_permissions_add',
    ...
    $service->register(new MethodDefinition(
        ...
        callback:     'ws_permissions_remove',
    ...
    $service->register(new MethodDefinition(
        ...
        callback:    'ws_users_preferences_set',
    ...
    $service->register(new MethodDefinition(
        ...
        callback:    'ws_users_favorites_add',
    ...
    $service->register(new MethodDefinition(
        ...
        callback:    'ws_users_favorites_remove',
    ...
    $service->register(new MethodDefinition(
        ...
        callback:    'ws_users_favorites_getList',
    ...
    $service->register(new MethodDefinition(
        ...
        callback:    'ws_images_filteredSearch_create',
        params:      [
    ...
    $service->register(new MethodDefinition(
        ...
        callback:     'ws_users_generate_password_link',
    ...
    $service->register(new MethodDefinition(
        ...
        callback:     'ws_userComments_getList',
        ...
        tags:         ['comments'],
        requiresAuth: true,
        includeFile:  $ws_functions_root . 'pwg.comments.php',
    ));

    $service->register(new MethodDefinition(
        name:         'pwg.userComments.delete',
        callback:     'ws_userComments_delete',
    ...
    $service->register(new MethodDefinition(
        ...
        callback:     'ws_userComments_validate',
