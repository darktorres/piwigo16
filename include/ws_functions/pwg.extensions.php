...
function ws_extensions_ignoreupdate(array $params, \Piwigo\Ws\PwgServer $service): PwgError|true
{
    ...
    if ($params['reset']) {
        ...
        conf_update_param('updates_ignored', serialize(\Piwigo\Config\Config::raw('updates_ignored')));
    ...
    $ignored_cfg_raw = \Piwigo\Config\Config::raw('updates_ignored');
...
function ws_extensions_checkupdates(array $params, \Piwigo\Ws\PwgServer $service): array
{
    ...
    $cu_updates_ignored_raw = \Piwigo\Config\Config::raw('updates_ignored');
