...
--
-- Name: set_lastmodified(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: COLUMN integrity_ignored_anomalies.version; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.integrity_ignored_anomalies.version IS 'Piwigo version the anomaly was ignored under';
...
ALTER TABLE ONLY public.integrity_ignored_anomalies
    ADD CONSTRAINT integrity_ignored_anomalies_pkey PRIMARY KEY (anomaly_id, version);
...
--
-- Name: categories trg_categories_lastmodified; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: groups trg_groups_lastmodified; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: images trg_images_lastmodified; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: tags trg_tags_lastmodified; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_tags_lastmodified BEFORE UPDATE ON public.tags FOR EACH ROW EXECUTE FUNCTION public.set_lastmodified();

--
-- Name: user_infos trg_user_infos_lastmodified; Type: TRIGGER; Schema: public; Owner: -
--
