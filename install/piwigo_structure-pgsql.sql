...
--
-- Name: COLUMN activity.activity_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.activity.activity_id IS 'surrogate primary key';

--
-- Name: COLUMN activity.object; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN activity.performed_by; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.activity.performed_by IS 'acting user id, null for an unresolved or system actor';

--
-- Name: COLUMN activity.session_idx; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN activity.ip_address; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.activity.ip_address IS 'REMOTE_ADDR of the request that triggered the action';

--
-- Name: COLUMN activity.occured_on; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.activity.occured_on IS 'when the action was recorded';

--
-- Name: COLUMN activity.details; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN activity.user_agent; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN audit_log.before_json; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN audit_log.after_json; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: caddie; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: TABLE caddie; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.caddie IS 'per-user temporary photo selection (caddie/basket) used by batch operations';

--
-- Name: COLUMN caddie.user_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.caddie.user_id IS 'owning user id';

--
-- Name: COLUMN caddie.element_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN categories.id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN categories.id_uppercat; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.categories.id_uppercat IS 'parent album id, null for a root album';

--
-- Name: COLUMN categories.comment; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.categories.comment IS 'album description shown on its page';

--
-- Name: COLUMN categories.dir; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN categories.rank; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.categories.rank IS 'sibling display order within the same parent, distinct from global_rank';

--
-- Name: COLUMN categories.status; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN categories.site_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.categories.site_id IS 'owning site id, resolves to sites.galleries_url for a physical album';

--
-- Name: COLUMN categories.visible; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN categories.image_order; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN categories.permalink; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.categories.permalink IS 'unique URL-friendly slug for this album';

--
-- Name: COLUMN categories.lastmodified; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN comments.id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.comments.id IS 'surrogate primary key';

--
-- Name: COLUMN comments.image_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.comments.image_id IS 'commented image id';

--
-- Name: COLUMN comments.date; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.comments.date IS 'when the comment was submitted';

--
-- Name: COLUMN comments.author; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN comments.validated; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN comments.validation_date; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN config.param; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: derivative_settings; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: TABLE derivative_settings; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN derivative_settings.id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.derivative_settings.id IS 'settings row identifier';

--
-- Name: COLUMN derivative_settings.default_quality; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN derivative_settings.watermark_json; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.derivative_settings.watermark_json IS 'encoded watermark configuration';

--
-- Name: COLUMN derivative_settings.custom_json; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.derivative_settings.custom_json IS 'encoded custom derivative-generation parameters';

--
-- Name: derivative_size; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: TABLE derivative_size; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN derivative_size.min_width; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN derivative_size.min_height; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN derivative_size.sharpen; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.derivative_size.sharpen IS 'sharpening amount from 0, none, to 1, max, see DerivativeParams::sharpen';

--
-- Name: COLUMN derivative_size.last_mod_time; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: extension_ignored_updates; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: TABLE extension_ignored_updates; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN extension_ignored_updates.extension_type; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.extension_ignored_updates.extension_type IS 'plugin, theme, or language, see ExtensionType';

--
-- Name: COLUMN extension_ignored_updates.extension_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN extension_ignored_updates.ignored_at; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN favorites.image_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.favorites.image_id IS 'image the user marked as a favorite';

--
-- Name: group_access; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: TABLE group_access; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.group_access IS 'per-group private album permission grants';

--
-- Name: COLUMN group_access.group_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.group_access.group_id IS 'granted group id';

--
-- Name: COLUMN group_access.cat_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN groups.is_default; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN groups.lastmodified; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN history.search_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.history.search_id IS 'search being viewed, set when section is search';

--
-- Name: COLUMN history.tag_ids; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: history_summary; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: TABLE history_summary; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: TABLE image_category; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.image_category IS 'image-to-album membership, an image can belong to more than one album';

--
-- Name: COLUMN image_category.image_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.image_category.image_id IS 'member image id';

--
-- Name: COLUMN image_category.category_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.image_category.category_id IS 'album the image belongs to';

--
-- Name: COLUMN image_category.rank; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN image_format.filesize; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.image_format.filesize IS 'file size of this alternate format in KB';

--
-- Name: image_format_format_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: COLUMN image_tag.image_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.image_tag.image_id IS 'tagged image id';

--
-- Name: COLUMN image_tag.tag_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN images.file; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.images.file IS 'base filename of the original file';

--
-- Name: COLUMN images.date_available; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN images.date_creation; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.images.date_creation IS 'date the photo was taken, typically synced from EXIF/IPTC metadata';

--
-- Name: COLUMN images.name; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN images.author; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.images.author IS 'photographer/author credit';

--
-- Name: COLUMN images.hit; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.images.hit IS 'view counter';

--
-- Name: COLUMN images.filesize; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.images.filesize IS 'original file size in KB';

--
-- Name: COLUMN images.width; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.images.width IS 'original pixel width';

--
-- Name: COLUMN images.height; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.images.height IS 'original pixel height';

--
-- Name: COLUMN images.coi; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.images.coi IS 'center of interest';

--
-- Name: COLUMN images.representative_ext; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN images.date_metadata_update; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN images.rating_score; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN images.path; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.images.path IS 'full relative filesystem path to the original file';

--
-- Name: COLUMN images.storage_category_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN images.level; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: integrity_ignored_anomalies; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: TABLE integrity_ignored_anomalies; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN integrity_ignored_anomalies.anomaly_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.integrity_ignored_anomalies.anomaly_id IS 'add_anomaly()-generated md5 id, see CheckIntegrity';

--
-- Name: COLUMN integrity_ignored_anomalies.piwigo_version; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.integrity_ignored_anomalies.piwigo_version IS 'Piwigo version the anomaly was ignored under';

--
-- Name: COLUMN integrity_ignored_anomalies.ignored_at; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN languages.version; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: lounge; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: TABLE old_permalinks; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN old_permalinks.cat_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.old_permalinks.cat_id IS 'album the removed permalink used to point to';

--
-- Name: COLUMN old_permalinks.permalink; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN old_permalinks.date_deleted; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.old_permalinks.date_deleted IS 'when the permalink was retired';

--
-- Name: COLUMN old_permalinks.last_hit; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.old_permalinks.last_hit IS 'when the dead permalink was last visited';

--
-- Name: COLUMN old_permalinks.hit; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: TABLE plugin_migrations; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN plugins.id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN plugins.state; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN rate.rate; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.rate.rate IS 'submitted rating value, restricted to the configured rate_items';

--
-- Name: COLUMN rate.date; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: TABLE search; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.search IS 'saved/shareable search queries';

--
-- Name: COLUMN search.id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.search.id IS 'surrogate primary key';

--
-- Name: COLUMN search.search_uuid; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN sessions.expiration; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN sites.id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.sites.id IS 'surrogate primary key, referenced by categories.site_id';

--
-- Name: COLUMN sites.galleries_url; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN tags.url_name; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN themes.id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN themes.version; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.themes.version IS 'installed theme version string';

--
-- Name: COLUMN themes.name; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: TABLE user_access; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.user_access IS 'per-user private album permission grants';

--
-- Name: COLUMN user_access.user_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.user_access.user_id IS 'granted user id';

--
-- Name: COLUMN user_access.cat_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.user_access.cat_id IS 'private album the user is granted access to';

--
-- Name: user_auth_keys; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: TABLE user_auth_keys; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.user_auth_keys IS 'persistent-login tokens and personal API keys, two row shapes sharing one table';

--
-- Name: COLUMN user_auth_keys.auth_key_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.user_auth_keys.auth_key_id IS 'surrogate primary key';

--
-- Name: COLUMN user_auth_keys.auth_key; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN user_auth_keys.apikey_secret; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN user_auth_keys.user_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.user_auth_keys.user_id IS 'owning user id';

--
-- Name: COLUMN user_auth_keys.created_on; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.user_auth_keys.created_on IS 'when the key was issued';

--
-- Name: COLUMN user_auth_keys.duration; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN user_auth_keys.expired_on; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.user_auth_keys.expired_on IS 'when the key stops being valid';

--
-- Name: COLUMN user_auth_keys.apikey_name; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN user_auth_keys.key_type; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: TABLE user_failed_logins; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN user_failed_logins.id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.user_failed_logins.id IS 'surrogate primary key';

--
-- Name: COLUMN user_failed_logins.user_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN user_failed_logins.ip; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.user_failed_logins.ip IS 'REMOTE_ADDR the failed login attempt came from';

--
-- Name: COLUMN user_failed_logins.attempted_at; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.user_failed_logins.attempted_at IS 'when the failed attempt occurred';

--
-- Name: user_failed_logins_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: TABLE user_feed; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.user_feed IS 'per-user private RSS feed tokens';

--
-- Name: COLUMN user_feed.id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN user_feed.user_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.user_feed.user_id IS 'user this feed token authenticates as';

--
-- Name: COLUMN user_feed.last_check; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: TABLE user_group; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.user_group IS 'user to group membership';

--
-- Name: COLUMN user_group.user_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.user_group.user_id IS 'member user id';

--
-- Name: COLUMN user_group.group_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN user_infos.level; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.user_infos.level IS 'effective permission level, gates access to images.level-restricted photos';

--
-- Name: COLUMN user_infos.activation_key; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN user_infos.activation_key_expire; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.user_infos.activation_key_expire IS 'when activation_key stops being valid';

--
-- Name: COLUMN user_infos.last_visit; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.user_infos.last_visit IS 'when the user was last seen, refreshed once per session length';

--
-- Name: COLUMN user_infos.last_visit_from_history; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN user_infos.lastmodified; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.user_infos.lastmodified IS 'row last-update timestamp';

--
-- Name: COLUMN user_infos.preferences; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: user_mail_notification; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: TABLE user_mail_notification; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.user_mail_notification IS 'per-user new-photo email notification subscriptions';

--
-- Name: COLUMN user_mail_notification.user_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.user_mail_notification.user_id IS 'subscribing user id';

--
-- Name: COLUMN user_mail_notification.check_key; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN user_mail_notification.enabled; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN user_mail_notification.last_send; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: caddie caddie_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: categories categories_i3_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: derivative_settings derivative_settings_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: derivative_size derivative_size_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: extension_ignored_updates extension_ignored_updates_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: group_access group_access_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: groups groups_ui1_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: history_summary history_summary_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: history_summary history_summary_ymdh; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: integrity_ignored_anomalies integrity_ignored_anomalies_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: lounge lounge_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: old_permalinks old_permalinks_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sites sites_ui1_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_auth_keys user_auth_keys_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_failed_logins user_failed_logins_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_mail_notification user_mail_notification_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_mail_notification user_mail_notification_ui1_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: users users_ui1_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: categories_representative_picture_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: favorites_image_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX favorites_image_id_idx ON public.favorites USING btree (image_id);

--
-- Name: group_access_cat_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: image_format_image_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: images_added_by_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: lounge_category_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: search_created_by_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX search_created_by_idx ON public.search USING btree (created_by);

--
-- Name: search_forked_from_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: user_access_cat_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX user_access_cat_id_idx ON public.user_access USING btree (cat_id);

--
-- Name: user_auth_keys_user_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX user_auth_keys_user_id_idx ON public.user_auth_keys USING btree (user_id);

--
-- Name: user_feed_user_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: caddie fk_caddie_user_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: categories fk_categories_id_uppercat; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: categories fk_categories_representative_picture_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: comments fk_comments_image_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: favorites fk_favorites_image_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: favorites fk_favorites_user_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: group_access fk_group_access_cat_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: group_access fk_group_access_group_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: history fk_history_auth_key_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: history fk_history_category_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: history fk_history_format_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: history fk_history_image_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: history fk_history_search_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: history fk_history_user_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: image_category fk_image_category_category_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: image_category fk_image_category_image_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: image_format fk_image_format_image_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: image_tag fk_image_tag_image_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: image_tag fk_image_tag_tag_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: images fk_images_added_by; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: images fk_images_storage_category_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: lounge fk_lounge_category_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: lounge fk_lounge_image_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: rate fk_rate_user_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: search fk_search_created_by; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: search fk_search_forked_from; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_access fk_user_access_cat_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_access fk_user_access_user_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_auth_keys fk_user_auth_keys_user_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_failed_logins fk_user_failed_logins_user_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_feed fk_user_feed_user_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_infos fk_user_infos_user_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_mail_notification fk_user_mail_notification_user_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
