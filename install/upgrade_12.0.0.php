...
INSERT INTO `' . PREFIX_TABLE . 'upgrade`
  ...
  VALUES
  (\'' . $upgrade_id . '\', NOW(), \'[migration from 12.0.0 to ' . PHPWG_VERSION . ', ' . \Piwigo\Core\TimingHelper::getElapsedTime($up_start, \Piwigo\Core\TimingHelper::getMoment()) . '] ' . $upgrade_description . '\')
;';
    pwg_query($query);
}
