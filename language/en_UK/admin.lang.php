...
$lang['Install the PHP exif extension, or set %s to false in the database config table'] = "Install the PHP exif extension, or set %s to false in the database config table";
