 ...
 * confirmed both live (a real convolveImage(array) call throws a
 * TypeError) and via this environment's own installed extension's native
 * reflection (ReflectionMethod::getParameters() reports `ImagickKernel
 * $kernel`, not `array`). PHPStan's bundled stub lives inside
