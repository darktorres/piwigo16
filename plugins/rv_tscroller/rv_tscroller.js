    ...
    // User can scroll to top/bottom and content auto-loads
        ...
        RVTS = Object.assign(RVTS, {
            ...
            checkAutoScroll: function (evt) {
                ...
                // Proactively load before user reaches bottom (75% of viewport height buffer)
                var loadBuffer = !evt ? 0 : Math.floor(window.innerHeight * 0.75);
                tBot -= loadBuffer;
            ...
            checkAutoScrollUp: function (evt) {
                ...
                // Proactively load before user reaches top (75% of viewport height buffer)
                var loadBuffer = !evt ? 0 : Math.floor(window.innerHeight * 0.75);
                tTop += loadBuffer;
