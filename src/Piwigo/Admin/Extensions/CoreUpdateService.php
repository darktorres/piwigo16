 ...
 *
 * Real callers: `Bootstrap\PageTail::checkForUpdates()` (called from
 * `prepareContext()`) constructs it directly; `Admin\UpdatesPwgPageRenderer`
 * and `Controller\Api\Extensions\CheckUpdatesController` both take it
