 ...
 * historical list of phpwebgallery-1.x-era file paths (kept verbatim,
 * including the generating shell script preserved as a comment) plus an
 * unlink/rmdir loop over whatever still exists relative to the gallery
 * root. The loop and echo output are byte-identical to the original.
 */
final class Patch80 implements DbPatchInterface
{
     ...
     * done
     */
    private const array LIST_FILES = [
    ...
    private const array LIST_EXCLUDE_FILES = [
        'local/config/database.inc.php',
    ];
    ...
    {
        return 'Delete old and not used files';
    }
