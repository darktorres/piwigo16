...
final readonly class GroupListView implements View, HasPageAssets, ExposesPageData
{
    ...
    public function pageAssets(): array
    {
        return [
            ...
            AssetContribution::script('group_list', 'themes/admin/default/js/group_list.ts', loadMode: LoadMode::Footer, dependsOn: ['jquery.selectize', 'page-data', 'LocalStorageCache']),
