...
final readonly class MaintenanceActionsView implements View, HasPageAssets, ExposesPageData
{
    ...
    public function pageAssets(): array
    {
        return [
            ...
            AssetContribution::script('maintenance_actions', 'themes/admin/default/js/maintenance/actions.ts', loadMode: LoadMode::Footer),
            AssetContribution::script('ajax', 'themes/admin/default/js/maintenance/maintenance.ts', loadMode: LoadMode::Footer),
        ];
    }
