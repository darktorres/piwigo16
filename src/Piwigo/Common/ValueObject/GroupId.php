...
final readonly class GroupId implements NumericId
{
    ...
    {
        if ($value <= 0) {
            throw new InvalidArgumentException("GroupId must be a positive integer, got {$value}");
        }
