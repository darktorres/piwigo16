...
final readonly class RateId implements NumericId
{
    ...
    {
        if ($value <= 0) {
            throw new \InvalidArgumentException("RateId must be a positive integer, got {$value}");
        }
