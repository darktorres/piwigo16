...
final readonly class SearchId implements NumericId
{
    ...
    {
        if ($value <= 0) {
            throw new InvalidArgumentException("SearchId must be a positive integer, got {$value}");
        }
