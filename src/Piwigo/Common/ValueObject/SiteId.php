...
final readonly class SiteId implements NumericId
{
    ...
    {
        if ($value <= 0) {
            throw new InvalidArgumentException("SiteId must be a positive integer, got {$value}");
        }
