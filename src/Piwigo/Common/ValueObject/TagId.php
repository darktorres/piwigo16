...
final readonly class TagId implements NumericId
{
    ...
    {
        if ($value <= 0) {
            throw new \InvalidArgumentException("TagId must be a positive integer, got {$value}");
        }
