 ...
 *
 * Shape matches `docs/schemas/theme.schema.json` (`^[a-zA-Z0-9_-]+$`, 1-64
 * chars). Used as a filesystem path component for `themes/<id>/…`, so the
 * shape constraint doubles as a directory-traversal guard.
 */
final readonly class ThemeId implements StringVo
{
