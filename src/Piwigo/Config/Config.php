...
final class Config
{
    ...
    {
        $default = ['RSS' => ['max_dates' => 7, 'max_elements' => 5, 'max_cats' => 8], 'NBM' => ['max_dates' => 7, 'max_elements' => 5, 'max_cats' => 8]];
