...
final class Config
{
     ...
     */
    public const SCHEMA = [
    'activate_comments'                            => ['type' => 'bool'   , 'default' => true                  , 'method' => 'activateComments'],
    'activity_display_connections'                 => ['type' => 'string' , 'default' => 'all'                 , 'method' => 'activityDisplayConnections'],
    'add_cache_to_storage_chart'                   => ['type' => 'bool'   , 'default' => true                  , 'method' => 'addCacheToStorageChart'],
    'admin_theme'                                  => ['type' => 'string' , 'default' => 'clear'               , 'method' => 'adminTheme'],
    'album_description_on_all_pages'               => ['type' => 'bool'   , 'default' => false                 , 'method' => 'albumDescriptionOnAllPages'],
    'album_move_delay_before_auto_opening'         => ['type' => 'int'    , 'default' => 3000                  , 'method' => 'albumMoveDelayBeforeAutoOpening'],
    'allow_html_descriptions'                      => ['type' => 'bool'   , 'default' => true                  , 'method' => 'allowHtmlDescriptions'],
    'allow_html_in_metadata'                       => ['type' => 'bool'   , 'default' => false                 , 'method' => 'allowHtmlInMetadata'],
    'allow_random_representative'                  => ['type' => 'bool'   , 'default' => false                 , 'method' => 'allowRandomRepresentative'],
    'allow_user_customization'                     => ['type' => 'bool'   , 'default' => true                  , 'method' => 'allowUserCustomization'],
    'allow_user_registration'                      => ['type' => 'bool'   , 'default' => true                  , 'method' => 'allowUserRegistration'],
    'allow_web_services'                           => ['type' => 'bool'   , 'default' => true                  , 'method' => 'allowWebServices'],
    'alternative_pem_url'                          => ['type' => 'string' , 'default' => ''                    , 'method' => 'alternativePemUrl'],
    'animated_webp_compression_quality'            => ['type' => 'int'    , 'default' => 70                    , 'method' => 'animatedWebpCompressionQuality'],
    'anti-flood_time'                              => ['type' => 'int'    , 'default' => 60                    , 'method' => 'antiFloodTime'],
    'apache_authentication'                        => ['type' => 'bool'   , 'default' => false                 , 'method' => 'apacheAuthentication'],
    'api_key_duration'                             => ['type' => 'array'  , 'default' => null                  , 'method' => 'apiKeyDuration', 'custom' => true],
    'api_key_forbidden_methods'                    => ['type' => 'array'  , 'default' => null                  , 'method' => 'apiKeyForbiddenMethods', 'custom' => true],
    'auth_key_duration'                            => ['type' => 'int'    , 'default' => 3 * 24 * 60 * 60      , 'method' => 'authKeyDuration'],
    'authorize_remembering'                        => ['type' => 'bool'   , 'default' => true                  , 'method' => 'authorizeRemembering'],
    'available_permission_levels'                  => ['type' => 'array'  , 'default' => null                  , 'method' => 'availablePermissionLevels', 'custom' => true],
    'batch_manager_images_per_page_global'         => ['type' => 'int'    , 'default' => 20                    , 'method' => 'batchManagerImagesPerPageGlobal'],
    'batch_manager_images_per_page_unit'           => ['type' => 'int'    , 'default' => 5                     , 'method' => 'batchManagerImagesPerPageUnit'],
    'browser_language'                             => ['type' => 'bool'   , 'default' => true                  , 'method' => 'browserLanguage'],
    'c13y_ignore'                                  => ['type' => 'string' , 'default' => null                  , 'method' => 'c13yIgnore', 'nullable' => true],
    'cache_sizes'                                  => ['type' => 'string' , 'default' => null                  , 'method' => 'cacheSizes', 'nullable' => true],
    'calendar_datefield'                           => ['type' => 'string' , 'default' => 'date_creation'       , 'method' => 'calendarDatefield'],
    'calendar_show_any'                            => ['type' => 'bool'   , 'default' => true                  , 'method' => 'calendarShowAny'],
    'calendar_show_empty'                          => ['type' => 'bool'   , 'default' => true                  , 'method' => 'calendarShowEmpty'],
    'category_url_style'                           => ['type' => 'string' , 'default' => 'id'                  , 'method' => 'categoryUrlStyle'],
    'check_upgrade_feed'                           => ['type' => 'bool'   , 'default' => false                 , 'method' => 'checkUpgradeFeed'],
    'checksum_compute_blocksize'                   => ['type' => 'int'    , 'default' => 50                    , 'method' => 'checksumComputeBlocksize'],
    'chmod_value'                                  => ['type' => 'int'    , 'default' => 0o755                 , 'method' => 'chmodValue'],
    'comment_spam_max_links'                       => ['type' => 'int'    , 'default' => 3                     , 'method' => 'commentSpamMaxLinks'],
    'comment_spam_reject'                          => ['type' => 'bool'   , 'default' => true                  , 'method' => 'commentSpamReject'],
    'comments_author_mandatory'                    => ['type' => 'bool'   , 'default' => false                 , 'method' => 'commentsAuthorMandatory'],
    'comments_email_mandatory'                     => ['type' => 'bool'   , 'default' => false                 , 'method' => 'commentsEmailMandatory'],
    'comments_enable_website'                      => ['type' => 'bool'   , 'default' => true                  , 'method' => 'commentsEnableWebsite'],
    'comments_forall'                              => ['type' => 'bool'   , 'default' => false                 , 'method' => 'commentsForall'],
    'comments_order'                               => ['type' => 'string' , 'default' => 'ASC'                 , 'method' => 'commentsOrder'],
    'comments_page_nb_comments'                    => ['type' => 'int'    , 'default' => 10                    , 'method' => 'commentsPageNbComments'],
    'comments_validation'                          => ['type' => 'bool'   , 'default' => false                 , 'method' => 'commentsValidation'],
    'compiled_template_cache_language'             => ['type' => 'bool'   , 'default' => false                 , 'method' => 'compiledTemplateCacheLanguage'],
    'content_tag_cloud_items_number'               => ['type' => 'int'    , 'default' => 12                    , 'method' => 'contentTagCloudItemsNumber'],
    'dashboard_activity_nb_weeks'                  => ['type' => 'int'    , 'default' => 4                     , 'method' => 'dashboardActivityNbWeeks'],
    'dashboard_check_for_updates'                  => ['type' => 'bool'   , 'default' => true                  , 'method' => 'dashboardCheckForUpdates'],
    'data_location'                                => ['type' => 'string' , 'default' => '_data/'              , 'method' => 'dataLocation'],
    'db_base'                                      => ['type' => 'string' , 'default' => ''                    , 'method' => 'dbName'],
    'db_host'                                      => ['type' => 'string' , 'default' => 'localhost'           , 'method' => 'dbHost'],
    'db_password'                                  => ['type' => 'string' , 'default' => ''                    , 'method' => 'dbPassword'],
    'db_user'                                      => ['type' => 'string' , 'default' => ''                    , 'method' => 'dbUser'],
    'debug_l10n'                                   => ['type' => 'bool'   , 'default' => false                 , 'method' => 'debugL10n'],
    'debug_mail'                                   => ['type' => 'bool'   , 'default' => false                 , 'method' => 'debugMail'],
    'debug_template'                               => ['type' => 'bool'   , 'default' => false                 , 'method' => 'debugTemplate'],
    'default_filters_views'                        => ['type' => 'array'  , 'default' => null                  , 'method' => 'defaultFiltersViews', 'custom' => true],
    'default_redirect_method'                      => ['type' => 'string' , 'default' => 'http'                , 'method' => 'defaultRedirectMethod'],
    'default_user_id'                              => ['type' => 'int'    , 'default' => 2                     , 'method' => 'defaultUserId'],
    'derivative_default_size'                      => ['type' => 'string' , 'default' => 'medium'              , 'method' => 'derivativeDefaultSize'],
    'derivative_url_style'                         => ['type' => 'int'    , 'default' => 0                     , 'method' => 'derivativeUrlStyle'],
    'derivatives'                                  => ['type' => 'string' , 'default' => null                  , 'method' => 'derivatives', 'nullable' => true],
    'derivatives_strip_metadata_threshold'         => ['type' => 'int'    , 'default' => 256000                , 'method' => 'derivativesStripMetadataThreshold'],
    'die_on_sql_error'                             => ['type' => 'bool'   , 'default' => false                 , 'method' => 'dieOnSqlError'],
    'disabled_derivatives'                         => ['type' => 'string' , 'default' => null                  , 'method' => 'disabledDerivatives', 'nullable' => true],
    'display_fromto'                               => ['type' => 'bool'   , 'default' => false                 , 'method' => 'displayFromto'],
    'double_password_type_in_admin'                => ['type' => 'bool'   , 'default' => false                 , 'method' => 'doublePasswordTypeInAdmin'],
    'email_admin_on_comment'                       => ['type' => 'string' , 'default' => 'none'                , 'method' => 'emailAdminOnComment'],
    'email_admin_on_comment_deletion'              => ['type' => 'string' , 'default' => 'none'                , 'method' => 'emailAdminOnCommentDeletion'],
    'email_admin_on_comment_edition'               => ['type' => 'string' , 'default' => 'none'                , 'method' => 'emailAdminOnCommentEdition'],
    'email_admin_on_comment_validation'            => ['type' => 'string' , 'default' => 'none'                , 'method' => 'emailAdminOnCommentValidation'],
    'email_admin_on_new_user'                      => ['type' => 'string' , 'default' => 'none'                , 'method' => 'emailAdminOnNewUser'],
    'empty_lounge_running'                         => ['type' => 'string' , 'default' => null                  , 'method' => 'emptyLoungeRunning', 'nullable' => true],
    'enable_core_update'                           => ['type' => 'bool'   , 'default' => true                  , 'method' => 'enableCoreUpdate'],
    'enable_extensions_install'                    => ['type' => 'bool'   , 'default' => true                  , 'method' => 'enableExtensionsInstall'],
    'enable_formats'                               => ['type' => 'bool'   , 'default' => false                 , 'method' => 'isFormatsEnabled'],
    'enable_plugins'                               => ['type' => 'bool'   , 'default' => true                  , 'method' => 'enablePlugins'],
    'enable_synchronization'                       => ['type' => 'bool'   , 'default' => true                  , 'method' => 'enableSynchronization'],
    'ext_imagick_dir'                              => ['type' => 'string' , 'default' => ''                    , 'method' => 'extImagickDir'],
    'extents_for_templates'                        => ['type' => 'string' , 'default' => null                  , 'method' => 'extentsForTemplates', 'nullable' => true, 'custom' => true],
    'external_authentification'                    => ['type' => 'bool'   , 'default' => false                 , 'method' => 'externalAuthentification'],
    'ffmpeg_dir'                                   => ['type' => 'string' , 'default' => ''                    , 'method' => 'ffmpegDir'],
    'file_ext'                                     => ['type' => 'array'  , 'default' => null                  , 'method' => 'fileExtensions', 'custom' => true],
    'filter_pages'                                 => ['type' => 'array'  , 'default' => null                  , 'method' => 'filterPages', 'custom' => true],
    'filters_views'                                => ['type' => 'string' , 'default' => null                  , 'method' => 'filtersViews', 'nullable' => true],
    'format_ext'                                   => ['type' => 'array'  , 'default' => null                  , 'method' => 'formatExtensions', 'custom' => true],
    'fs_quick_check_last_check'                    => ['type' => 'string' , 'default' => null                  , 'method' => 'fsQuickCheckLastCheck', 'nullable' => true],
    'fs_quick_check_period'                        => ['type' => 'int'    , 'default' => 86400                 , 'method' => 'fsQuickCheckPeriod'],
    'full_tag_cloud_items_number'                  => ['type' => 'int'    , 'default' => 200                   , 'method' => 'fullTagCloudItemsNumber'],
    'gallery_locked'                               => ['type' => 'bool'   , 'default' => false                 , 'method' => 'galleryLocked'],
    'gallery_title'                                => ['type' => 'string' , 'default' => 'Piwigo'              , 'method' => 'galleryTitle'],
    'gallery_url'                                  => ['type' => 'string' , 'default' => null                  , 'method' => 'galleryUrl', 'nullable' => true],
    'graphics_library'                             => ['type' => 'string' , 'default' => 'auto'                , 'method' => 'graphicsLibrary'],
    'guest_access'                                 => ['type' => 'bool'   , 'default' => true                  , 'method' => 'guestAccess'],
    'guest_id'                                     => ['type' => 'int'    , 'default' => 2                     , 'method' => 'guestId'],
    'header_notes'                                 => ['type' => 'array'  , 'default' => null                  , 'method' => 'headerNotes', 'custom' => true],
    'history_admin'                                => ['type' => 'bool'   , 'default' => false                 , 'method' => 'historyAdmin'],
    'history_autopurge_blocksize'                  => ['type' => 'int'    , 'default' => 50000                 , 'method' => 'historyAutopurgeBlocksize'],
    'history_autopurge_every'                      => ['type' => 'int'    , 'default' => 1021                  , 'method' => 'historyAutopurgeEvery'],
    'history_autopurge_keep_lines'                 => ['type' => 'int'    , 'default' => 1000000               , 'method' => 'historyAutopurgeKeepLines'],
    'history_guest'                                => ['type' => 'bool'   , 'default' => false                 , 'method' => 'historyGuest'],
    'history_sections_cache'                       => ['type' => 'string' , 'default' => null                  , 'method' => 'historySectionsCache', 'nullable' => true],
    'history_summarized_dropped'                   => ['type' => 'bool'   , 'default' => false                 , 'method' => 'historySummarizedDropped'],
    'home_page'                                    => ['type' => 'string' , 'default' => 'recent_pics'         , 'method' => 'homePage'],
    'index_caddie_icon'                            => ['type' => 'bool'   , 'default' => true                  , 'method' => 'indexCaddieIcon'],
    'index_created_date_icon'                      => ['type' => 'bool'   , 'default' => true                  , 'method' => 'indexCreatedDateIcon'],
    'index_edit_icon'                              => ['type' => 'bool'   , 'default' => true                  , 'method' => 'indexEditIcon'],
    'index_flat_icon'                              => ['type' => 'bool'   , 'default' => true                  , 'method' => 'indexFlatIcon'],
    'index_new_icon'                               => ['type' => 'bool'   , 'default' => true                  , 'method' => 'indexNewIcon'],
    'index_posted_date_icon'                       => ['type' => 'bool'   , 'default' => true                  , 'method' => 'indexPostedDateIcon'],
    'index_search_in_set_action'                   => ['type' => 'string' , 'default' => 'results'             , 'method' => 'indexSearchInSetAction'],
    'index_search_in_set_button'                   => ['type' => 'bool'   , 'default' => false                 , 'method' => 'indexSearchInSetButton'],
    'index_sizes_icon'                             => ['type' => 'bool'   , 'default' => true                  , 'method' => 'indexSizesIcon'],
    'index_slideshow_icon'                         => ['type' => 'bool'   , 'default' => true                  , 'method' => 'indexSlideShowIcon'],
    'index_sort_order_input'                       => ['type' => 'string' , 'default' => ''                    , 'method' => 'indexSortOrderInput'],
    'inheritance_by_default'                       => ['type' => 'bool'   , 'default' => false                 , 'method' => 'inheritanceByDefault'],
    'insensitive_case_logon'                       => ['type' => 'bool'   , 'default' => false                 , 'method' => 'insensitiveCaseLogon'],
    'last_major_update'                            => ['type' => 'string' , 'default' => null                  , 'method' => 'lastMajorUpdate', 'nullable' => true],
    'level_separator'                              => ['type' => 'string' , 'default' => ' / '                 , 'method' => 'levelSeparator'],
    'light_album_manager_threshold'                => ['type' => 'int'    , 'default' => 10000                 , 'method' => 'lightAlbumManagerThreshold'],
    'light_slideshow'                              => ['type' => 'bool'   , 'default' => true                  , 'method' => 'lightSlideshow'],
    'linked_album_search_limit'                    => ['type' => 'int'    , 'default' => 100                   , 'method' => 'linkedAlbumSearchLimit'],
    'links'                                        => ['type' => 'array'  , 'default' => null                  , 'method' => 'links', 'custom' => true],
    'log'                                          => ['type' => 'bool'   , 'default' => false                 , 'method' => 'logConf'],
    'log_archive_days'                             => ['type' => 'int'    , 'default' => 30                    , 'method' => 'logArchiveDays'],
    'log_dir'                                      => ['type' => 'string' , 'default' => '/logs'               , 'method' => 'logDir'],
    'log_level'                                    => ['type' => 'string' , 'default' => 'DEBUG'               , 'method' => 'logLevel'],
    'lounge_activate_threshold'                    => ['type' => 'int'    , 'default' => 1                     , 'method' => 'loungeActivateThreshold'],
    'lounge_active'                                => ['type' => 'bool'   , 'default' => false                 , 'method' => 'loungeActive'],
    'lounge_max_duration'                          => ['type' => 'int'    , 'default' => 300                   , 'method' => 'loungeMaxDuration'],
    'mail_allow_html'                              => ['type' => 'bool'   , 'default' => true                  , 'method' => 'mailAllowHtml'],
    'mail_sender_email'                            => ['type' => 'string' , 'default' => ''                    , 'method' => 'mailSenderEmail'],
    'mail_sender_name'                             => ['type' => 'string' , 'default' => ''                    , 'method' => 'mailSenderName'],
    'mail_theme'                                   => ['type' => 'string' , 'default' => 'clear'               , 'method' => 'mailTheme'],
    'max_requests'                                 => ['type' => 'int'    , 'default' => 3                     , 'method' => 'maxRequests'],
    'menubar_filter_icon'                          => ['type' => 'bool'   , 'default' => true                  , 'method' => 'menubarFilterIcon'],
    'menubar_tag_cloud_content'                    => ['type' => 'string' , 'default' => 'all_or_current'      , 'method' => 'menubarTagCloudContent'],
    'menubar_tag_cloud_items_number'               => ['type' => 'int'    , 'default' => 20                    , 'method' => 'menubarTagCloudItemsNumber'],
    'meta_ref'                                     => ['type' => 'bool'   , 'default' => true                  , 'method' => 'metaRef'],
    'metadata_keyword_separator_regex'             => ['type' => 'string' , 'default' => '/[.,;]/'             , 'method' => 'metadataKeywordSeparatorRegex'],
    'mobile_theme'                                 => ['type' => 'string' , 'default' => ''                    , 'method' => 'mobilTheme'],
    'nb_categories_page'                           => ['type' => 'int'    , 'default' => 9999                  , 'method' => 'nbCategoriesPage'],
    'nb_comment_page'                              => ['type' => 'int'    , 'default' => 10                    , 'method' => 'nbCommentPage'],
    'nb_logs_page'                                 => ['type' => 'int'    , 'default' => 300                   , 'method' => 'nbLogsPage'],
    'nbm_complementary_mail_content'               => ['type' => 'string' , 'default' => ''                    , 'method' => 'nbmComplementaryMailContent'],
    'nbm_default_value_user_enabled'               => ['type' => 'bool'   , 'default' => false                 , 'method' => 'nbmDefaultValueUserEnabled'],
    'nbm_list_all_enabled_users_to_send'           => ['type' => 'bool'   , 'default' => false                 , 'method' => 'nbmListAllEnabledUsersToSend'],
    'nbm_max_treatment_timeout_percent'            => ['type' => 'float'  , 'default' => 0.8                   , 'method' => 'nbmMaxTreatmentTimeoutPercent', 'custom' => true],
    'nbm_send_detailed_content'                    => ['type' => 'bool'   , 'default' => true                  , 'method' => 'nbmSendDetailedContent'],
    'nbm_send_html_mail'                           => ['type' => 'bool'   , 'default' => true                  , 'method' => 'nbmSendHtmlMail'],
    'nbm_send_mail_as'                             => ['type' => 'string' , 'default' => ''                    , 'method' => 'nbmSendMailAs'],
    'nbm_send_recent_post_dates'                   => ['type' => 'bool'   , 'default' => true                  , 'method' => 'nbmSendRecentPostDates'],
    'nbm_treatment_timeout_default'                => ['type' => 'int'    , 'default' => 20                    , 'method' => 'nbmTreatmentTimeoutDefault'],
    'never_delete_originals'                       => ['type' => 'bool'   , 'default' => false                 , 'method' => 'neverDeleteOriginals'],
    'newcat_default_commentable'                   => ['type' => 'bool'   , 'default' => true                  , 'method' => 'newcatDefaultCommentable'],
    'newcat_default_position'                      => ['type' => 'string' , 'default' => 'first'               , 'method' => 'newcatDefaultPosition'],
    'newcat_default_status'                        => ['type' => 'string' , 'default' => 'public'              , 'method' => 'newcatDefaultStatus'],
    'newcat_default_visible'                       => ['type' => 'bool'   , 'default' => true                  , 'method' => 'newcatDefaultVisible'],
    'no_photo_yet_url'                             => ['type' => 'string' , 'default' => 'admin.php?page=photos_add', 'method' => 'noPhotoYetUrl'],
    'obligatory_user_mail_address'                 => ['type' => 'bool'   , 'default' => false                 , 'method' => 'obligatoryUserMailAddress'],
    'order_by'                                     => ['type' => 'string' , 'default' => ''                    , 'method' => 'orderBy'],
    'order_by_custom'                              => ['type' => 'string' , 'default' => null                  , 'method' => 'orderByCustom', 'nullable' => true],
    'order_by_inside_category'                     => ['type' => 'string' , 'default' => ''                    , 'method' => 'orderByInsideCategory'],
    'order_by_inside_category_custom'              => ['type' => 'string' , 'default' => null                  , 'method' => 'orderByInsideCategoryCustom', 'nullable' => true],
    'original_resize'                              => ['type' => 'bool'   , 'default' => false                 , 'method' => 'originalResize'],
    'original_resize_maxheight'                    => ['type' => 'int'    , 'default' => 2000                  , 'method' => 'originalResizeMaxheight'],
    'original_resize_maxwidth'                     => ['type' => 'int'    , 'default' => 2000                  , 'method' => 'originalResizeMaxwidth'],
    'original_resize_quality'                      => ['type' => 'int'    , 'default' => 95                    , 'method' => 'originalResizeQuality'],
    'original_url_protection'                      => ['type' => 'string' , 'default' => ''                    , 'method' => 'originalUrlProtection'],
    'page_banner'                                  => ['type' => 'string' , 'default' => ''                    , 'method' => 'pageBanner'],
    'paginate_pages_around'                        => ['type' => 'int'    , 'default' => 2                     , 'method' => 'paginatePagesAround'],
    'password_activation_duration'                 => ['type' => 'int'    , 'default' => 259200                , 'method' => 'passwordActivationDuration'],
    'password_hash'                                => ['type' => 'string' , 'default' => 'pwg_password_hash'   , 'method' => 'passwordHash', 'custom' => true],
    'password_reset_code_duration'                 => ['type' => 'int'    , 'default' => 300                   , 'method' => 'passwordResetCodeDuration'],
    'password_reset_duration'                      => ['type' => 'int'    , 'default' => 3600                  , 'method' => 'passwordResetDuration'],
    'password_verify'                              => ['type' => 'string' , 'default' => 'pwg_password_verify' , 'method' => 'passwordVerify', 'custom' => true],
    'pdf_viewer_filesize_threshold'                => ['type' => 'int'    , 'default' => 5                     , 'method' => 'pdfViewerFilesizeThreshold'],
    'pem_languages_category'                       => ['type' => 'int'    , 'default' => 8                     , 'method' => 'pemLanguagesCategory'],
    'pem_plugins_category'                         => ['type' => 'int'    , 'default' => 12                    , 'method' => 'pemPluginsCategory'],
    'pem_themes_category'                          => ['type' => 'int'    , 'default' => 10                    , 'method' => 'pemThemesCategory'],
    'php_extension_in_urls'                        => ['type' => 'bool'   , 'default' => true                  , 'method' => 'phpExtensionInUrls'],
    'picture_caddie_icon'                          => ['type' => 'bool'   , 'default' => true                  , 'method' => 'pictureCaddieIcon'],
    'picture_download_icon'                        => ['type' => 'bool'   , 'default' => true                  , 'method' => 'pictureDownloadIcon'],
    'picture_edit_icon'                            => ['type' => 'bool'   , 'default' => true                  , 'method' => 'pictureEditIcon'],
    'picture_ext'                                  => ['type' => 'array'  , 'default' => null                  , 'method' => 'pictureExtensions', 'custom' => true],
    'picture_favorite_icon'                        => ['type' => 'bool'   , 'default' => true                  , 'method' => 'pictureFavoriteIcon'],
    'picture_informations'                         => ['type' => 'string' , 'default' => null                  , 'method' => 'pictureInformations', 'nullable' => true],
    'picture_menu'                                 => ['type' => 'bool'   , 'default' => true                  , 'method' => 'pictureMenu'],
    'picture_metadata_icon'                        => ['type' => 'bool'   , 'default' => true                  , 'method' => 'pictureMetadataIcon'],
    'picture_navigation_icons'                     => ['type' => 'bool'   , 'default' => true                  , 'method' => 'pictureNavigationIcons'],
    'picture_navigation_thumb'                     => ['type' => 'bool'   , 'default' => true                  , 'method' => 'pictureNavigationThumb'],
    'picture_representative_icon'                  => ['type' => 'bool'   , 'default' => true                  , 'method' => 'pictureRepresentativeIcon'],
    'picture_sizes_icon'                           => ['type' => 'bool'   , 'default' => true                  , 'method' => 'pictureSizesIcon'],
    'picture_slideshow_icon'                       => ['type' => 'bool'   , 'default' => true                  , 'method' => 'pictureSlideShowIcon'],
    'picture_url_style'                            => ['type' => 'string' , 'default' => 'id'                  , 'method' => 'pictureUrlStyle'],
    'piwigo_db_version'                            => ['type' => 'string' , 'default' => null                  , 'method' => 'piwigoDbVersion', 'nullable' => true],
    'piwigo_installed_version'                     => ['type' => 'string' , 'default' => null                  , 'method' => 'piwigoInstalledVersion', 'nullable' => true],
    'proxy_auth'                                   => ['type' => 'string' , 'default' => ''                    , 'method' => 'proxyAuth'],
    'proxy_server'                                 => ['type' => 'string' , 'default' => ''                    , 'method' => 'proxyServer'],
    'question_mark_in_urls'                        => ['type' => 'bool'   , 'default' => true                  , 'method' => 'questionMarkInUrls'],
    'quick_search_include_sub_albums'              => ['type' => 'bool'   , 'default' => false                 , 'method' => 'quickSearchIncludeSubAlbums'],
    ...
    'rate_anonymous'                               => ['type' => 'bool'   , 'default' => true                  , 'method' => 'rateAnonymous'],
    'rate_items'                                   => ['type' => 'array'  , 'default' => null                  , 'method' => 'rateItems', 'custom' => true],
    'recent_post_dates'                            => ['type' => 'array'  , 'default' => null                  , 'method' => 'recentPostDates', 'custom' => true],
    'related_albums_display_limit'                 => ['type' => 'int'    , 'default' => 20                    , 'method' => 'relatedAlbumsDisplayLimit'],
    'related_albums_maximum_items_to_compute'      => ['type' => 'int'    , 'default' => 1000                  , 'method' => 'relatedAlbumsMaximumItemsToCompute'],
    'remember_me_length'                           => ['type' => 'int'    , 'default' => 5184000               , 'method' => 'rememberMeLength'],
    'remember_me_name'                             => ['type' => 'string' , 'default' => 'pwg_remember'        , 'method' => 'rememberMeName'],
    'representative_cache_on_level'                => ['type' => 'bool'   , 'default' => true                  , 'method' => 'representativeCacheOnLevel'],
    'representative_cache_on_subcats'              => ['type' => 'bool'   , 'default' => true                  , 'method' => 'representativeCacheOnSubcats'],
    'rss_feed_author'                              => ['type' => 'string' , 'default' => 'Piwigo notifier'     , 'method' => 'rssReedAuthor'],
    'secret_key'                                   => ['type' => 'string' , 'default' => ''                    , 'method' => 'secretKey'],
    'send_bcc_mail_webmaster'                      => ['type' => 'bool'   , 'default' => false                 , 'method' => 'sendBccMailWebmaster'],
    'send_piwigo_infos'                            => ['type' => 'bool'   , 'default' => true                  , 'method' => 'sendPiwigoInfos'],
    'send_piwigo_infos_last_notice'                => ['type' => 'string' , 'default' => null                  , 'method' => 'sendPiwigoInfosLastNotice', 'nullable' => true],
    'send_piwigo_infos_origin_hash'                => ['type' => 'string' , 'default' => null                  , 'method' => 'sendPiwigoInfosOriginHash', 'nullable' => true],
    'session_gc_probability'                       => ['type' => 'int'    , 'default' => 1                     , 'method' => 'sessionGcProbability'],
    'session_length'                               => ['type' => 'int'    , 'default' => 3600                  , 'method' => 'sessionLength'],
    'session_name'                                 => ['type' => 'string' , 'default' => 'pwg_id'              , 'method' => 'sessionName'],
    'session_save_handler'                         => ['type' => 'string' , 'default' => 'db'                  , 'method' => 'sessionSaveHandler'],
    'session_use_cookies'                          => ['type' => 'bool'   , 'default' => true                  , 'method' => 'sessionUseCookies'],
    'session_use_ip_address'                       => ['type' => 'bool'   , 'default' => true                  , 'method' => 'sessionUseIpAddress'],
    'session_use_only_cookies'                     => ['type' => 'bool'   , 'default' => true                  , 'method' => 'sessionUseOnlyCookies'],
    'session_use_trans_sid'                        => ['type' => 'bool'   , 'default' => false                 , 'method' => 'sessionUseTransSid'],
    'show_exif'                                    => ['type' => 'bool'   , 'default' => true                  , 'method' => 'showExif'],
    'show_exif_fields'                             => ['type' => 'array'  , 'default' => null                  , 'method' => 'showExifFields', 'custom' => true],
    'show_gt'                                      => ['type' => 'bool'   , 'default' => false                 , 'method' => 'showGt'],
    'show_iptc'                                    => ['type' => 'bool'   , 'default' => false                 , 'method' => 'showIptc'],
    'show_iptc_mapping'                            => ['type' => 'array'  , 'default' => null                  , 'method' => 'showIptcMapping', 'custom' => true],
    'show_newsletter_subscription'                 => ['type' => 'bool'   , 'default' => true                  , 'method' => 'showNewsletterSubscription'],
    'show_php_errors'                              => ['type' => 'int'    , 'default' => E_ALL                 , 'method' => 'showPhpErrors'],
    'show_php_errors_on_frontend'                  => ['type' => 'bool'   , 'default' => true                  , 'method' => 'showPhpErrorsOnFrontend'],
    'show_piwigo_latest_news'                      => ['type' => 'bool'   , 'default' => true                  , 'method' => 'showPiwigoLatestNews'],
    'show_queries'                                 => ['type' => 'bool'   , 'default' => false                 , 'method' => 'showQueries'],
    'show_template_in_side_menu'                   => ['type' => 'bool'   , 'default' => false                 , 'method' => 'showTemplateInSideMenu'],
    'show_thumbnail_caption'                       => ['type' => 'bool'   , 'default' => true                  , 'method' => 'showThumbnailCaption'],
    'show_version'                                 => ['type' => 'bool'   , 'default' => false                 , 'method' => 'showVersion'],
    'slideshow_period'                             => ['type' => 'int'    , 'default' => 4                     , 'method' => 'slideshowPeriod'],
    'slideshow_period_max'                         => ['type' => 'int'    , 'default' => 10                    , 'method' => 'slideshowPeriodMax'],
    'slideshow_period_min'                         => ['type' => 'int'    , 'default' => 1                     , 'method' => 'slideshowPeriodMin'],
    'slideshow_period_step'                        => ['type' => 'int'    , 'default' => 1                     , 'method' => 'slideshowPeriodStep'],
    'slideshow_repeat'                             => ['type' => 'bool'   , 'default' => true                  , 'method' => 'slideshowRepeat'],
    'smtp_host'                                    => ['type' => 'string' , 'default' => ''                    , 'method' => 'smtpHost'],
    'smtp_password'                                => ['type' => 'string' , 'default' => ''                    , 'method' => 'smtpPassword'],
    'smtp_secure'                                  => ['type' => 'string' , 'default' => null                  , 'method' => 'smtpSecure', 'nullable' => true],
    'smtp_user'                                    => ['type' => 'string' , 'default' => ''                    , 'method' => 'smtpUser'],
    'stat_compare_year_displayed'                  => ['type' => 'int'    , 'default' => 5                     , 'method' => 'statCompareYearDisplayed'],
    'sync_chars_regex'                             => ['type' => 'string' , 'default' => '/^[a-zA-Z0-9-_.]+$/' , 'method' => 'syncCharsRegex'],
    'sync_exclude_folders'                         => ['type' => 'array'  , 'default' => null                  , 'method' => 'syncExcludeFolders', 'custom' => true],
    'tag_letters_column_number'                    => ['type' => 'int'    , 'default' => 4                     , 'method' => 'tagLettersColumnNumber'],
    'tag_url_style'                                => ['type' => 'string' , 'default' => 'id-tag'              , 'method' => 'tagUrlStyle'],
    'tags_default_display_mode'                    => ['type' => 'string' , 'default' => 'cloud'               , 'method' => 'tagsDefaultDisplayMode'],
    'tags_levels'                                  => ['type' => 'int'    , 'default' => 5                     , 'method' => 'tagsLevels'],
    'template_combine_files'                       => ['type' => 'bool'   , 'default' => true                  , 'method' => 'templateCombineFiles'],
    'template_compile_check'                       => ['type' => 'bool'   , 'default' => true                  , 'method' => 'templateCompileCheck'],
    'template_force_compile'                       => ['type' => 'bool'   , 'default' => false                 , 'method' => 'templateForceCompile'],
    'themes_dir'                                   => ['type' => 'string' , 'default' => ''                    , 'method' => 'themesDir'],
    'tiff_representative_ext'                      => ['type' => 'string' , 'default' => 'png'                 , 'method' => 'tiffRepresentativeExt'],
    'top_number'                                   => ['type' => 'int'    , 'default' => 15                    , 'method' => 'topNumber'],
    'uniqueness_mode'                              => ['type' => 'string' , 'default' => 'md5sum'              , 'method' => 'uniquenessMode'],
    'update_notify_check_period'                   => ['type' => 'int'    , 'default' => 86400                 , 'method' => 'updateNotifyCheckPeriod'],
    'update_notify_last_check'                     => ['type' => 'string' , 'default' => null                  , 'method' => 'updateNotifyLastCheck', 'nullable' => true],
    'update_notify_last_notification'              => ['type' => 'string' , 'default' => null                  , 'method' => 'updateNotifyLastNotification', 'nullable' => true],
    'update_notify_reminder_period'                => ['type' => 'int'    , 'default' => 604800                , 'method' => 'updateNotifyReminderPeriod'],
    'updates_ignored'                              => ['type' => 'array'  , 'default' => null                  , 'method' => 'updatesIgnored', 'custom' => true],
    'upload_detect_duplicate'                      => ['type' => 'bool'   , 'default' => true                  , 'method' => 'uploadDetectDuplicate'],
    'upload_dir'                                   => ['type' => 'string' , 'default' => './upload'            , 'method' => 'uploadDir'],
    'upload_form_all_types'                        => ['type' => 'bool'   , 'default' => false                 , 'method' => 'uploadFormAllTypes'],
    'upload_form_automatic_rotation'               => ['type' => 'bool'   , 'default' => true                  , 'method' => 'uploadFormAutomaticRotation'],
    'upload_form_chunk_size'                       => ['type' => 'int'    , 'default' => 500                   , 'method' => 'uploadFormChunkSize'],
    'upload_form_max_file_size'                    => ['type' => 'int'    , 'default' => 1000                  , 'method' => 'uploadFormMaxFileSize'],
    'url_port'                                     => ['type' => 'string' , 'default' => 'none'                , 'method' => 'urlPort'],
    'use_exif'                                     => ['type' => 'bool'   , 'default' => true                  , 'method' => 'useExif'],
    'use_exif_mapping'                             => ['type' => 'array'  , 'default' => null                  , 'method' => 'useExifMapping', 'custom' => true],
    'use_iptc'                                     => ['type' => 'bool'   , 'default' => false                 , 'method' => 'useIptc'],
    'use_iptc_mapping'                             => ['type' => 'array'  , 'default' => null                  , 'method' => 'useIptcMapping', 'custom' => true],
    'use_proxy'                                    => ['type' => 'bool'   , 'default' => false                 , 'method' => 'useProxy'],
    'user_can_delete_comment'                      => ['type' => 'bool'   , 'default' => false                 , 'method' => 'userCanDeleteComment'],
    'user_can_edit_comment'                        => ['type' => 'bool'   , 'default' => false                 , 'method' => 'userCanEditComment'],
    'user_fields'                                  => ['type' => 'array'  , 'default' => null                  , 'method' => 'userFields', 'custom' => true],
    'users_table'                                  => ['type' => 'string' , 'default' => null                  , 'method' => 'usersTable', 'nullable' => true],
    'webmaster_id'                                 => ['type' => 'int'    , 'default' => 1                     , 'method' => 'webmasterId'],
    'week_starts_on'                               => ['type' => 'string' , 'default' => 'monday'              , 'method' => 'weekStartsOn'],
    'ws_max_images_per_page'                       => ['type' => 'int'    , 'default' => 500                   , 'method' => 'wsMaxImagesPerPage'],
    'ws_max_users_per_page'                        => ['type' => 'int'    , 'default' => 1000                  , 'method' => 'wsMaxUsersPerPage'],
    ];
