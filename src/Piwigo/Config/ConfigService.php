...
final readonly class ConfigService
{
    ...
    private const array KEY_TO_PROPERTY = [
        ...
        'password_reset_request_ip_max_attempts' => 'passwordResetRequestIpMaxAttempts',
        'password_reset_request_max_attempts' => 'passwordResetRequestMaxAttempts',
        'password_reset_request_window_minutes' => 'passwordResetRequestWindowMinutes',
