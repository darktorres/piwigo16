...
/**
 * `POST /api/v1/groups/{id}/actions/add-user` -- `pwg.groups.addUser`'s
 ...
 * ever runs.
 */
final readonly class GroupAddUserController implements ControllerInterface
{
    ...
    public function __invoke(ServerRequestInterface $request): ResponseInterface
    {
        ...
        $added = $this->groupService->addMembers(
