...
final class Container
{
     ...
     * $mountDepth/$isApi/$isAdmin: RequestMountDepth/ApiContext/AdminContext
     *   are immutable per-request facts known only by the one entry-shell file
     ...
     *   guard against).
     */
    public static function build(array $extraDefinitions = [], ?Paths $paths = null, int $mountDepth = 0, bool $isApi = false, bool $isAdmin = false): ContainerInterface
    {
        ...
        $builder->addDefinitions([
            ...
            ApiContext::class => new ApiContext($isApi),
