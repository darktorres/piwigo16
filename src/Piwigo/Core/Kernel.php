...
final class Kernel
{
    ...
    public static function boot(?Paths $paths = null, int $mountDepth = 0, bool $isApi = false, bool $isAdmin = false): void
    {
        if (self::$booted) {
        ...
        self::$container = Container::build(paths: $paths, mountDepth: $mountDepth, isApi: $isApi, isAdmin: $isAdmin);
    }
