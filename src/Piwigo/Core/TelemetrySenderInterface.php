 ...
 * bound in config/container.php; `Piwigo\Bootstrap\PageTail::prepareContext()`
 * passes the concrete instance into PageTailRenderer's own constructor,
 * as its own required argument.
 */
