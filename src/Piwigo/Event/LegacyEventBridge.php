...
final class LegacyEventBridge
{
    ...
    public const array MAP = [
        ...
        'get_element_metadata_available' => Picture\GetElementMetadataAvailable::class,
        ...
        'loc_index_thumbnails_selection' => Location\LocIndexThumbnailsSelection::class,
        ...
        'render_category_literal_description' => Template\RenderCategoryLiteralDescription::class,
        ...
        'render_page_banner' => Template\RenderPageBanner::class,
