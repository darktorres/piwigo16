...
final readonly class RoutingMiddleware implements MiddlewareInterface
{
    ...
    public function process(ServerRequestInterface $request, RequestHandlerInterface $handler): ResponseInterface
    {
        ...
        // reachable at all, via CurrentPluginRegistry -- has already run
        // by the time THIS runs (BOOTSTRAP_MIDDLEWARE precedes
        // RoutingMiddleware in Bootstrap\RequestPipeline::DEFAULT_MIDDLEWARE),
        // but Router::class itself gets constructed much earlier, when
        // Bootstrap\RequestPipeline::handle()'s own array_map() eagerly
        // resolves every middleware instance up front -- before ANY
        // middleware's own process() (including PluginBootstrapMiddleware's)
        // has actually run.
