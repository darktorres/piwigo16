 ...
 * ImageService::associateImagesToCategories()}'s own signature accepts a
 * numeric-string image id defensively -- $categoryId/$rank are genuinely
 * exercised as both shapes today: {@see \Piwigo\Image\
