 ...
 * make_index_url(), get_categories_menu(), get_related_categories_menu(),
 * script_basename(), get_available_tags(), tags_counter_compare(), l10n(),
 * get_root_url(), get_nb_available_tags(), get_nb_available_comments(),
 * is_autorize_status(), is_admin()) stay as plain global-function calls to
 * modules migrated in earlier phases.
 *
