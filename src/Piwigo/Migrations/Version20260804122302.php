...
final class Version20260804122302 extends AbstractMigration
{
    ...
    private function upPostgres(): void
    {
        ...
        $this->addSql(
            ...
            'occured_on timestamp NOT NULL DEFAULT now(), ' .
        ...
        $this->addSql(
            ...
            "section varchar(20) DEFAULT NULL CHECK (section IS NULL OR section IN ('categories', 'tags', 'search', 'list', 'favorites', 'most_visited', 'best_rated', 'recent_pics', 'recent_cats')), " .
    ...
    private function withMysqlPrefix(string $sql): string
    {
        ...
        $prefixed = str_replace('piwigo_', DbCredentials::current()->prefix, $protected);
