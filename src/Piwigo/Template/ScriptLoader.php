...
final class ScriptLoader
{
    ...
    {
        $combiner = new FileCombiner('js', self::urlService(), \Piwigo\Core\CurrentPaths::get(), \Piwigo\PluginConfig\EventDispatcher::get(), \Piwigo\Template\CurrentTemplate::current(), $scripts);
