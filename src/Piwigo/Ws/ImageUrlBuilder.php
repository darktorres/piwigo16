...
/**
 * Returns an array map of urls (thumb/element) for image_row - to be
 * returned in a standard way by different web service methods. Split out
 * of the former WsHelper god-class (P25 Stage 1 step 6).
 */
