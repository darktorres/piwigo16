...
/**
 * Sets an image's category associations -- shared by `AddHandler` and
 * `SetInfoHandler` (the god-class `Images::addImageCategoryRelations()`
 * private helper both used), extracted into its own service since it's
 * no longer possible for two separate `WsAction` classes to share a
 * private method on a single god-class.
 */
