...
final class WsCommentsMutationTest extends ContractTestCase
{
    ...
    public function testValidateCommentReturnsOk(): void
    {
    ...
    public function testDeleteCommentReturnsOk(): void
    {
        $commentId = $this->addComment();
        $token = $this->getPwgToken();
    ...
    public function testValidateInvalidTokenReturnsError(): void
    {
        $response = $this->callWs('pwg.userComments.validate', [
            'comment_id' => [1],
            'pwg_token' => 'wrong',
