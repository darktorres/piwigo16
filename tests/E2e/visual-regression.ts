...
const ROUTES: ReadonlyArray<{
    ...
    {
        name: 'tags-filtered',
        path: '/index.php?/tags/1-landscape',
        baselinePath: '/index.php?/tags/1-nature',
        needsAuth: false,
    },
    ...
    {
        name: 'most-visited',
        path: '/index.php?/most_visited',
        baselinePath: '/index.php?/most-visited',
        needsAuth: true,
    },
    {
        name: 'recent-pics',
        path: '/index.php?/recent_pics',
        baselinePath: '/index.php?/recent',
        needsAuth: true,
    },
    {
        name: 'recent-cats',
        path: '/index.php?/recent_cats',
        baselinePath: '/index.php?/recent-albums',
        needsAuth: true,
    },
    {
        name: 'best-rated',
        path: '/index.php?/best_rated',
        baselinePath: '/index.php?/best-rated',
        needsAuth: true,
    },
    { name: 'profile', path: '/index.php?/profile', needsAuth: true },
    {
        name: 'calendar',
        path: '/index.php?/created-monthly-calendar',
        baselineSkip: true,
        needsAuth: false,
    },
    ...
    {
        name: 'admin-album-perms',
        path: '/index.php?/admin&page=album&cat_id=1&tab=permissions',
        needsAuth: true,
    },
    ...
    {
        name: 'admin-album-notif',
        path: '/index.php?/admin&page=album_notification&cat_id=1',
        needsAuth: true,
    },
    ...
    {
        name: 'admin-photos-add-ftp',
        path: '/index.php?/admin&page=photos_add&section=ftp',
        needsAuth: true,
    },
    {
        name: 'admin-photos-add-apps',
        path: '/index.php?/admin&page=photos_add&section=applications',
        needsAuth: true,
    },
    {
        name: 'admin-photo-editor',
        path: '/index.php?/admin&page=photo&image_id=1',
        needsAuth: true,
    },
    {
        name: 'admin-picture-coi',
        path: '/index.php?/admin&page=picture_coi&image_id=1',
        needsAuth: true,
    },
    { name: 'admin-batch', path: '/index.php?/admin&page=batch_manager', needsAuth: true },
    {
        name: 'admin-batch-global',
        path: '/index.php?/admin&page=batch_manager_global',
        needsAuth: true,
    },
    {
        name: 'admin-element-ranks',
        path: '/index.php?/admin&page=element_set_ranks&cat_id=1',
        needsAuth: true,
    },
    ...
    {
        name: 'admin-group-perm',
        path: '/index.php?/admin&page=group_perm&group_id=1',
        needsAuth: true,
    },
    {
        name: 'admin-user-perm',
        path: '/index.php?/admin&page=user_perm&user_id=1',
        needsAuth: true,
    },
    ...
    {
        name: 'admin-themes-std',
        path: '/index.php?/admin&page=themes_standard_pages',
        needsAuth: true,
    },
    {
        name: 'admin-languages',
        path: '/index.php?/admin&page=languages_installed',
        needsAuth: true,
    },
    ...
    {
        name: 'admin-extend-tpl',
        path: '/index.php?/admin&page=extend_for_templates',
        needsAuth: true,
    },
    ...
    {
        name: 'admin-maintenance-env',
        path: '/index.php?/admin&page=maintenance_env',
        needsAuth: true,
    },
    {
        name: 'admin-maintenance-sys',
        path: '/index.php?/admin&page=maintenance_sys',
        needsAuth: true,
    },
    ...
    { name: 'admin-site-manager', path: '/index.php?/admin&page=site_manager', needsAuth: true },
    {
        ...
        path: '/index.php?/admin&page=site_update&site=1',
        needsAuth: true,
    },
    ...
    {
        name: 'admin-notif-mail',
        path: '/index.php?/admin&page=notification_by_mail',
        needsAuth: true,
    },
...
async function capture(): Promise<void> {
    ...
    await page.goto(url('/index.php?/identification'), {
    ...
    for (const route of ROUTES) {
        if (IS_BASELINE && route.baselineSkip === true) {
        ...
        try {
            const routePath =
                IS_BASELINE && route.baselinePath !== undefined ? route.baselinePath : route.path;
            ...
            throw new Error(`${route.name}: ${message}`, { cause: err });
        }
    }
