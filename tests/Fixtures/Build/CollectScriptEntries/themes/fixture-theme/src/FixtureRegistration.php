...
namespace Piwigo\Tests\Fixtures\Build\CollectScriptEntries\FixtureTheme;

use Piwigo\Asset\AssetContribution;

/**
 * Fixture-only, never autoloaded/instantiated by the real application --
 * exercises `collectScriptEntries()`'s theme-`src/`-scanning branch
...
final class FixtureRegistration
{
    ...
    {
        return [
            AssetContribution::script('fixture-theme-entry', 'themes/fixture-theme/src/fixture-theme.ts'),
        ];
    }
}
