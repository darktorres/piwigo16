...
ALTER TABLE IF EXISTS ONLY public.password_reset_requests DROP CONSTRAINT IF EXISTS fk_password_reset_requests_user_id;
...
DROP INDEX IF EXISTS public.idx_password_reset_requests_user_time;
DROP INDEX IF EXISTS public.idx_password_reset_requests_ip_time;
...
--
-- Name: password_reset_requests; Type: TABLE; Schema: public; Owner: piwigo_fixture_regen
--
...
ALTER TABLE public.password_reset_requests OWNER TO piwigo_fixture_regen;

--
-- Name: TABLE password_reset_requests; Type: COMMENT; Schema: public; Owner: piwigo_fixture_regen
--

COMMENT ON TABLE public.password_reset_requests IS 'password-reset-code requests, read and written by PasswordController::processVerificationCode() via PasswordResetRequestRepository to rate-limit how often a fresh code can be requested';


--
-- Name: COLUMN password_reset_requests.id; Type: COMMENT; Schema: public; Owner: piwigo_fixture_regen
--

COMMENT ON COLUMN public.password_reset_requests.id IS 'surrogate primary key';


--
-- Name: COLUMN password_reset_requests.user_id; Type: COMMENT; Schema: public; Owner: piwigo_fixture_regen
--

COMMENT ON COLUMN public.password_reset_requests.user_id IS 'targeted user id, if the submitted username/email resolved to a real account';


--
-- Name: COLUMN password_reset_requests.ip; Type: COMMENT; Schema: public; Owner: piwigo_fixture_regen
--

COMMENT ON COLUMN public.password_reset_requests.ip IS 'REMOTE_ADDR the reset-code request came from';


--
-- Name: COLUMN password_reset_requests.requested_at; Type: COMMENT; Schema: public; Owner: piwigo_fixture_regen
--

COMMENT ON COLUMN public.password_reset_requests.requested_at IS 'when the reset-code request occurred';


--
-- Name: password_reset_requests_id_seq; Type: SEQUENCE; Schema: public; Owner: piwigo_fixture_regen
--
...
COPY public.audit_log (id, actor_id, action, entity_type, entity_id, before_json, after_json, ip_address, created_at, prev_hash, row_hash, group_id) FROM stdin;
1	1	create	group	1	\N	{"name": "Editors"}	::1	2026-08-01 00:00:00	\N	fb08569e0a181f3c519a47ed7faed20c576f9aee1d4ba3361bfb5d9bc9ffbbe0	1
2	1	create	group	2	\N	{"name": "Reviewers"}	::1	2026-08-01 00:00:00	fb08569e0a181f3c519a47ed7faed20c576f9aee1d4ba3361bfb5d9bc9ffbbe0	425622dddcec305339ccef4d45d997d899b77bcd4fc4ead48ff7df01a6dbc53b	2
3	1	create	group	3	\N	{"name": "Guests"}	::1	2026-08-01 00:00:00	425622dddcec305339ccef4d45d997d899b77bcd4fc4ead48ff7df01a6dbc53b	964f6fe6c7316cb7897260dffb899337c55e0d85c47c386f131533c5b209052f	3
\.
...
--
-- Data for Name: password_reset_requests; Type: TABLE DATA; Schema: public; Owner: piwigo_fixture_regen
--

COPY public.password_reset_requests (id, user_id, ip, requested_at) FROM stdin;
\.
...
--
-- Name: password_reset_requests_id_seq; Type: SEQUENCE SET; Schema: public; Owner: piwigo_fixture_regen
--
...
--
-- Name: password_reset_requests password_reset_requests_pkey; Type: CONSTRAINT; Schema: public; Owner: piwigo_fixture_regen
--
...
--
-- Name: idx_password_reset_requests_ip_time; Type: INDEX; Schema: public; Owner: piwigo_fixture_regen
--

CREATE INDEX idx_password_reset_requests_ip_time ON public.password_reset_requests USING btree (ip, requested_at);


--
-- Name: idx_password_reset_requests_user_time; Type: INDEX; Schema: public; Owner: piwigo_fixture_regen
--

CREATE INDEX idx_password_reset_requests_user_time ON public.password_reset_requests USING btree (user_id, requested_at);
...
--
-- Name: password_reset_requests fk_password_reset_requests_user_id; Type: FK CONSTRAINT; Schema: public; Owner: piwigo_fixture_regen
--

ALTER TABLE ONLY public.password_reset_requests
    ADD CONSTRAINT fk_password_reset_requests_user_id FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
