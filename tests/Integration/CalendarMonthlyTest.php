...
namespace Piwigo\Tests\Integration {
    ...
    final class CalendarMonthlyTest extends IntegrationTestCase
    {
        ...
        public function testGetDateWhereWithAFullYearMonthDaySelectsASingleDay(): void
        {
         ...
         */
        public function testGetDateWhereRespectsLeapYearsWhenOnlyYearAndMonthAreSelected(): void
        {
            $calendar = $this->makeCalendar();
            ...
            ], $where2023->parameters);
        }

        public function testGetDateWhereTreatsAnyAsAWildcardForYearOrMonth(): void
        {
            $calendar = $this->makeCalendar();
         ...
         * entry point.
         */
        public function testBuildNextPrevNavigatesCorrectlyRegardlessOfChronologyDateElementType(): void
        {
        ...
        public function testGenerateCategoryContentListViewBuildsYearThenMonthThenDayNavBars(): void
        {
         ...
         */
        public function testBuildNavBarAutoNarrowsChronologyDateAndSkipsTheBarForASingleValue(): void
        {
            $calendar = new CalendarMonthly(LangTestFactory::get(), new CalendarRepository(EntityManagerFactory::build($this->conn)), $this->urlService, CurrentConfigTestFactory::get(), ImageStdParamsTestFactory::get());
            $calendar->chronology_field = 'posted';
         ...
         */
        public function testBuildNextPrevAppendsTheCurrentPeriodWhenNoRealPeriodMatchesIt(): void
        {
            $calendar = $this->makeCalendar();
            $calendar->chronology_view = CalendarBase::CAL_VIEW_CALENDAR;
         ...
         */
        public function testBuildGlobalCalendarBailsOutToYearViewWhenOnlyOneYearExists(): void
        {
            $calendar = new CalendarMonthly(LangTestFactory::get(), new CalendarRepository(EntityManagerFactory::build($this->conn)), $this->urlService, CurrentConfigTestFactory::get(), ImageStdParamsTestFactory::get());
            $calendar->chronology_field = 'posted';
         ...
         */
        public function testBuildYearCalendarBailsOutToMonthViewWhenOnlyOneMonthExists(): void
        {
            $calendar = new CalendarMonthly(LangTestFactory::get(), new CalendarRepository(EntityManagerFactory::build($this->conn)), $this->urlService, CurrentConfigTestFactory::get(), ImageStdParamsTestFactory::get());
            $calendar->chronology_field = 'posted';
            $calendar->initialize($this->makeScope('id IN (4,5)'));
         ...
         */
        public function testBuildMonthCalendarPadsTrailingDaysToCompleteTheFinalWeek(): void
        {
            $calendar = new CalendarMonthly(LangTestFactory::get(), new CalendarRepository(EntityManagerFactory::build($this->conn)), $this->urlService, CurrentConfigTestFactory::get(), ImageStdParamsTestFactory::get());
            $calendar->chronology_field = 'posted';
        ...
        public function testBuildMonthCalendarPopulatesARealThumbnailForADayWithImages(): void
        {
