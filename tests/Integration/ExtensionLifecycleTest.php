...
namespace Piwigo\Tests\Integration {
    ...
    final class ExtensionLifecycleTest extends IntegrationTestCase
    {
        ...
        protected function setUp(): void
        {
            ...
            $this->lifecycle = new ExtensionLifecycle($this->repo, new PemCatalog(new ZipExtractor(), $currentLogger), new UrlService(new HtmlService()), new ConfigService($this->buildConfigRepository(), new \Piwigo\PluginConfig\EventDispatcher()), $this->pluginMigrationRepo);
