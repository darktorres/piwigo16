...
final class MenubarRendererTest extends IntegrationTestCase
{
    ...
    public function test_render_escapes_the_query_search_value_for_a_search_section(): void
    {
        ...
        $this->renderer->render(\Piwigo\Auth\AccessControl::current(), $this->urlService, $this->filterState, $this->sectionContextRegistry, $this->sessionService, new \Piwigo\Config\DeploymentPolicy(), \Piwigo\Users\CurrentUser::current(), CurrentTemplate::current());
