...
namespace Piwigo\Tests\Integration {
    ...
    final class NotificationServiceTest extends IntegrationTestCase
    {
        ...
        public function testCustomNotificationQueryReturnsNullForAnUnknownType(): void
        {
            self::assertNull($this->service->customNotificationQuery('count', 'bogus_type'));
        }

        public function testCustomNotificationQueryCountsNewComments(): void
        {
        ...
        public function testCustomNotificationQueryReturnsIdsForInfoAction(): void
        {
         ...
         * just below.
         */
        public function testCustomNotificationQueryCountsUpdatedCategories(): void
        {
         ...
         */
        public function testCustomNotificationQueryCountsNewUsersViaDefaultRestrictArm(): void
        {
        ...
        public function testNbNewElementsCountsInRange(): void
        {
            self::assertSame(3, $this->service->nbNewElements('2026-07-07 05:02:36', '2026-07-07 05:02:38'));
        }

        public function testNewElementsReturnsIdsInRange(): void
        {
        ...
        public function testNewCommentsReturnsIdsInRange(): void
        {
        ...
        public function testNbNewUsersCountsInRange(): void
        {
            self::assertSame(2, $this->service->nbNewUsers('2026-07-07 05:02:35', '2026-07-07 05:02:39'));
        }

        public function testUpdatedCategoriesReturnsIdsInRange(): void
        {
        ...
        public function testNewUsersReturnsIdsInRange(): void
        {
        ...
        public function testNewsExistsIsTrueWhenNewElementsExist(): void
        {
        ...
        public function testNewsExistsIsFalseForAnEmptyWindow(): void
        {
            CurrentUserTestFactory::get()->set(CurrentUserTestFactory::get()->get()->withStatus(UserStatus::Normal));
        ...
        public function testNewsExistsConsidersUnvalidatedCommentsOnlyForAdmins(): void
        {
         ...
         */
        public function testGetRecentPostDatesGroupsAndCaches(): void
        {
        ...
        public function testGetRecentPostDatesArrayAppliesDefaults(): void
        {
        ...
        public function testNewsAppendsTheAuthKeyToEveryGeneratedUrl(): void
        {
            CurrentUserTestFactory::get()->set(CurrentUserTestFactory::get()->get()->withStatus(UserStatus::Normal));
        ...
        public function testNewsOmitsTheAuthParamEntirelyWhenNoAuthKeyIsGiven(): void
        {
            CurrentUserTestFactory::get()->set(CurrentUserTestFactory::get()->get()->withStatus(UserStatus::Normal));
        ...
        public function testGetHtmlDescriptionRecentPostDateAppendsTheAuthKeyToItsUrl(): void
        {
        ...
        public function testGetHtmlDescriptionRecentPostDateOmitsTheAuthParamWhenNoAuthKeyIsGiven(): void
        {
            $html = $this->service->getHtmlDescriptionRecentPostDate(
                [
                    'date_available' => '2026-07-15',
