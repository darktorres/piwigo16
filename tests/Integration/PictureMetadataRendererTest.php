...
final class PictureMetadataRendererTest extends IntegrationTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        CurrentConfigService::current()->set(new ConfigService($this->buildConfigRepository(), new EventDispatcher(), $currentConfig));
    ...
    public function test_render_appends_exif_metadata_with_direct_and_nested_field_tokens(): void
    {
        ...
        $this->renderer->render(Lang::current(), $this->makePicture($relativePath), $this->currentLogger, new EventDispatcher(), CurrentTemplate::current(), $currentConfig, CurrentUser::current(), SessionService::get(), new FilterState(), Paths::fromRoot(dirname(__DIR__, 2)));
