...
final class ReindexImagesHandlerTest extends IntegrationTestCase
{
    ...
    {
        $handler = new ReindexImagesHandler(new MetadataService(new MetadataRepository(\Piwigo\Db\EntityManagerFactory::build($this->conn)), new CurrentLogger(), new \Piwigo\PluginConfig\EventDispatcher()));
