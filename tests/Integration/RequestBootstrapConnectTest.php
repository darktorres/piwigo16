...
final class RequestBootstrapConnectTest extends IntegrationTestCase
{
    ...
    public function testConnectShowsAFatalErrorPageWhenTheDatabaseIsUnreachable(): void
    {
    ...
    public function testConnectStampsAFreshInstalledVersionAndLastMajorUpdateAppliesTheCustomOrderAndEmptiesTheLounge(): void
    {
    ...
    public function testConnectRecordsAnAutoupdateActivityAndRestampsTheVersionWhenItDiffersFromAppinfo(): void
    {
    ...
    // ------------------------------------- LoadedPlugins repopulation glue
     ...
     * genuinely scanned by the same `PluginRegistry` instance `connect()`
     * itself resolves.
     */
    public function testConnectPopulatesLoadedPluginsFromAnActivePluginRegistryEntry(): void
    {
        $pluginId = 'zz-rbconnect-active-' . bin2hex(random_bytes(4));
     ...
     */
    public function testConnectLeavesLoadedPluginsEmptyWhenPluginsAreDisabled(): void
    {
        $pluginId = 'zz-rbconnect-disabled-' . bin2hex(random_bytes(4));
        $this->writeFixturePlugin($pluginId);
        $this->conn->executeStatement(
            "INSERT INTO plugins (id, state, version) VALUES (?, 'active', '1.0.0')",
            [$pluginId],
    ...
    private function writeFixturePlugin(string $pluginId): void
    {
        ...
        file_put_contents($dir . '/plugin.json', json_encode([
            ...
            'name' => $pluginId,
            'version' => '1.0.0',
            'description' => 'Test-only fixture plugin (tests/Integration/RequestBootstrapConnectTest.php).',
            'license' => 'MIT',
            'minPiwigo' => '16.3.0',
