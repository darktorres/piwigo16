...
final class UploadServiceTest extends IntegrationTestCase
{
    ...
    public function testAddUploadedFileThrowsWhenTheGivenImageIdDoesNotExist(): void
    {
        ...
        $threw = null;
        try {
            new UploadService(LangTestFactory::get(), $this->currentLogger, $this->storageRegistry, EventDispatcherTestFactory::get(), $this->configService, $this->entityManager, $this->activityService, $this->metadataService, $this->imageService, $this->currentConfig, $this->wsContext, $this->currentUser, CurrentPathsTestFactory::get(), DbCredentialsTestFactory::get(), ImageStdParamsTestFactory::get(), $this->permissionService)->addUploadedFile($source, $this->urlService, 'orphan.png', image_id: 999_999);
    ...
    public function testAddUploadedFileResolvesANonStandardExtensionViaTheFinfoFallbackWhenAllTypesAllowed(): void
    {
        ...
        $imageId = new UploadService(LangTestFactory::get(), $this->currentLogger, $this->storageRegistry, EventDispatcherTestFactory::get(), $this->configService, $this->entityManager, $this->activityService, $this->metadataService, $this->imageService, $this->currentConfig, $this->wsContext, $this->currentUser, CurrentPathsTestFactory::get(), DbCredentialsTestFactory::get(), ImageStdParamsTestFactory::get(), $this->permissionService)->addUploadedFile($source, $this->urlService, 'archive.zip');
        $id = $imageId;
        $this->imageIdsToDelete[] = $id;
    ...
    public function testAddUploadedFileResizesTheOriginalWhenItExceedsTheConfiguredMaxDimensions(): void
    {
        ...
        $imageId = new UploadService(LangTestFactory::get(), $this->currentLogger, $this->storageRegistry, EventDispatcherTestFactory::get(), $this->configService, $this->entityManager, $this->activityService, $this->metadataService, $this->imageService, $this->currentConfig, $this->wsContext, $this->currentUser, CurrentPathsTestFactory::get(), DbCredentialsTestFactory::get(), ImageStdParamsTestFactory::get(), $this->permissionService)->addUploadedFile($source, $this->urlService, 'big.jpg');
        $id = $imageId;
        $this->imageIdsToDelete[] = $id;
    ...
    public function testAddUploadedFileStoresTheRepresentativeExtWhenAnUploadFileHandlerMatches(): void
    {
        ...
        EventDispatcherTestFactory::get()->addTypedHandler(UploadFile::class, $this->newService()->uploadFilePdf(...));
        ...
        try {
            ...
            $imageId = new UploadService(LangTestFactory::get(), $this->currentLogger, $this->storageRegistry, EventDispatcherTestFactory::get(), $this->configService, $this->entityManager, $this->activityService, $this->metadataService, $this->imageService, $this->currentConfig, $this->wsContext, $this->currentUser, CurrentPathsTestFactory::get(), DbCredentialsTestFactory::get(), ImageStdParamsTestFactory::get(), $this->permissionService)->addUploadedFile($pdf, $this->urlService, 'document.pdf');
            $id = $imageId;
            $this->imageIdsToDelete[] = $id;
    ...
    public function testAddUploadedFileRejectsAnExtensionAbsentFromFileExtensionsEvenWhenAllTypesAreAllowed(): void
    {
        ...
        $threw = null;
        try {
            new UploadService(LangTestFactory::get(), $this->currentLogger, $this->storageRegistry, EventDispatcherTestFactory::get(), $this->configService, $this->entityManager, $this->activityService, $this->metadataService, $this->imageService, $this->currentConfig, $this->wsContext, $this->currentUser, CurrentPathsTestFactory::get(), DbCredentialsTestFactory::get(), ImageStdParamsTestFactory::get(), $this->permissionService)->addUploadedFile($source, $this->urlService, 'payload.exe');
        } catch (ImageProcessingException $e) {
            $threw = $e;
        }
    ...
    public function testAddUploadedFileRejectsAForbiddenFileTypeAndDeletesTheSourceFile(): void
    {
        ...
        $threw = null;
        try {
            new UploadService(LangTestFactory::get(), $this->currentLogger, $this->storageRegistry, EventDispatcherTestFactory::get(), $this->configService, $this->entityManager, $this->activityService, $this->metadataService, $this->imageService, $this->currentConfig, $this->wsContext, $this->currentUser, CurrentPathsTestFactory::get(), DbCredentialsTestFactory::get(), ImageStdParamsTestFactory::get(), $this->permissionService)->addUploadedFile($source, $this->urlService, 'notes.txt');
        } catch (ImageProcessingException $e) {
            $threw = $e;
        }
    ...
    public function testAddUploadedFileAddToCategoriesFlipsLoungeActiveOnceThePhotoCountReachesTheThreshold(): void
    {
        ...
        $imageId = new UploadService(LangTestFactory::get(), $this->currentLogger, $this->storageRegistry, EventDispatcherTestFactory::get(), $this->configService, $this->entityManager, $this->activityService, $this->metadataService, $this->imageService, $this->currentConfig, $this->wsContext, $this->currentUser, CurrentPathsTestFactory::get(), DbCredentialsTestFactory::get(), ImageStdParamsTestFactory::get(), $this->permissionService)->addUploadedFile($source, $this->urlService, 'threshold.png');
    ...
    public function testAddUploadedFileAddToCategoriesAssociatesANewPhotoToTheGivenCategoriesWhenLoungeIsInactive(): void
    {
        ...
        $imageId = new UploadService(LangTestFactory::get(), $this->currentLogger, $this->storageRegistry, EventDispatcherTestFactory::get(), $this->configService, $this->entityManager, $this->activityService, $this->metadataService, $this->imageService, $this->currentConfig, $this->wsContext, $this->currentUser, CurrentPathsTestFactory::get(), DbCredentialsTestFactory::get(), ImageStdParamsTestFactory::get(), $this->permissionService)->addUploadedFile($source, $this->urlService, 'associate.png', categories: [1]);
        $id = $imageId;
        $this->imageIdsToDelete[] = $id;
    ...
    public function testUploadFileTiffFallsBackToTheSplitFileRenameWhenImagemagickProducesPerPageOutput(): void
    {
        ...
        $result = $this->uploadFileExt($this->newService()->uploadFileTiff(...), null, $tiff);
    ...
    public function testUploadFileHeicReachesItsTailReturnViaGetOptimalDimensionsForRepresentative(): void
    {
        ...
        $result = $this->uploadFileExt($this->newService()->uploadFileHeic(...), null, $heic);
    ...
    {
        $result = $this->uploadFileExt($this->newService()->uploadFileVideo(...), 'already-set', $this->marker . '/whatever.mp4');
    ...
    public function testUploadFileVideoGeneratesAPosterFromARealVideoAndLogsFfmpegsStderrOutput(): void
    {
        ...
        $result = $this->uploadFileExt($this->newService()->uploadFileVideo(...), null, $video);
    ...
    public function testUploadFileVideoReturnsNullAndFallsBackThroughAvconvWhenFfmpegCannotDecodeTheFile(): void
    {
        ...
        $result = $this->uploadFileExt($this->newService()->uploadFileVideo(...), null, $fake);
    ...
    /**
     * saveUploadFormConfig()'s own massUpdateValues() call now writes
     * through $this->entityManager's own connection directly (Finding 1's
     * fix retired the throwaway EntityManagerFactory::build(DbConnection::
     * build()) this used to go through), but that doesn't make the
     * explicit `$this->entityManager->clear()` call right after redundant:
     * massUpdateValues() is a raw connection-level bulk UPDATE
     * (ConfigRepository's own BatchWriter), which bypasses the ORM
     * identity map regardless of which EntityManager's connection issues
     * it -- clear() is still what evicts the already-cached, now-stale
     * ConfigEntry so a later find() re-queries instead of returning the
     * pre-write copy.
     */
    ...
    public function testThe5ExtImagickHandlersRecognizeAnUppercaseExtensionCaseInsensitively(): void
    {
        ...
        try {
            foreach ([
                [$this->newService()->uploadFilePdf(...), 'document.PDF'],
                [$this->newService()->uploadFileHeic(...), 'photo.HEIC'],
                [$this->newService()->uploadFileTiff(...), 'photo.TIFF'],
                [$this->newService()->uploadFilePsd(...), 'layered.PSD'],
                [$this->newService()->uploadFileEps(...), 'vector.EPS'],
            ] as [$handler, $filename]) {
                $threw = null;
                try {
    ...
    public function testUploadFileTiffAlsoRecognizesTheBareTifExtensionNotJustTiff(): void
    {
        ...
        try {
            $threw = null;
            try {
                $this->uploadFileExt($this->newService()->uploadFileTiff(...), null, $dir . '/photo.tif');
            } catch (ImageProcessingException $e) {
                $threw = $e;
            }
    ...
    public function testThe5ExtImagickHandlersUseTheConfiguredDirPrefixRatherThanABarePathLookup(): void
    {
        ...
        try {
            ...
            self::assertNull($this->uploadFileExt($this->newService()->uploadFilePdf(...), null, $pdf), 'a bogus configured ext_imagick dir must genuinely be prepended to the exec() command, not silently dropped in favor of a bare PATH lookup');

            $heic = $dir . '/dirbogus.heic';
            $this->makeFakeHeic($heic);
            self::assertNull($this->uploadFileExt($this->newService()->uploadFileHeic(...), null, $heic));

            $epsPng = $dir . '/dirbogus-eps-src.png';
            $this->makeSamplePng($epsPng);
            $eps = $dir . '/dirbogus.eps';
            $this->convertSample($epsPng, $eps);
            self::assertNull($this->uploadFileExt($this->newService()->uploadFileEps(...), null, $eps));

            $tiffPng = $dir . '/dirbogus-tiff-src.png';
            $this->makeSamplePng($tiffPng);
            $tiff = $dir . '/dirbogus.tiff';
            $this->convertSample($tiffPng, $tiff);
            $this->uploadFileExt($this->newService()->uploadFileTiff(...), null, $tiff);
            ...
            $this->uploadFileExt($this->newService()->uploadFilePsd(...), null, $psd);
    ...
    public function testThe5ExtImagickHandlersPrependTheConfiguredDirBeforeTheCommandNameNotAfter(): void
    {
        ...
        try {
            ...
            $pdf = $dir . '/dirreal.pdf';
            $this->convertSample($pdfPng, $pdf);
            self::assertSame('jpg', $this->uploadFileExt($this->newService()->uploadFilePdf(...), null, $pdf), 'the configured dir must be prepended before the command name, not appended after it, or the resulting shell word never resolves to a real executable');

            $heic = $dir . '/dirreal.heic';
            $this->makeFakeHeic($heic);
            self::assertSame('jpg', $this->uploadFileExt($this->newService()->uploadFileHeic(...), null, $heic));

            $epsPng = $dir . '/dirreal-eps-src.png';
            $this->makeSamplePng($epsPng);
            $eps = $dir . '/dirreal.eps';
            $this->convertSample($epsPng, $eps);
            self::assertSame('png', $this->uploadFileExt($this->newService()->uploadFileEps(...), null, $eps));
    ...
    public function testUploadFilePdfConvertsOnlyTheFirstPageViaThe0PageSelector(): void
    {
        ...
        $result = $this->uploadFileExt($this->newService()->uploadFilePdf(...), null, $pdf);
    ...
    public function testUploadFileHeicBuildsTheResizeGeometryFromTheExactOptimalWidthAndHeight(): void
    {
        ...
        $dims = $method->invoke($this->newService());
        [$maxW, $maxH] = $dims;
        ...
        try {
            ...
            $this->uploadFileExt($this->newService()->uploadFileHeic(...), null, $heic);
    ...
    public function testReadyForUploadMessageChmodsAnUnwritableExistingDirectoryToExactly0777(): void
    {
        ...
        try {
            $service = new UploadService(LangTestFactory::get(), $this->currentLogger, $this->storageRegistry, EventDispatcherTestFactory::get(), $this->configService, $this->entityManager, $this->activityService, $this->metadataService, $this->imageService, $this->currentConfig, $this->wsContext, $this->currentUser, Paths::fromRoot($root), DbCredentialsTestFactory::get(), ImageStdParamsTestFactory::get(), $this->permissionService);
