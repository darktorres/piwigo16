...
final class UploadServiceTest extends IntegrationTestCase
{
    ...
    public function test_addUploadedFile_inserts_a_new_photo_and_writes_it_to_real_storage(): void
    {
        ...
        $imageId = new UploadService($this->currentLogger, $this->storageRegistry, \Piwigo\PluginConfig\EventDispatcher::get(), $this->configService, $this->entityManager, $this->activityService, $this->metadataService, $this->imageService)->addUploadedFile($source, $this->urlService, 'holiday.png');
        $id = $imageId;
    ...
    public function test_addUploadedFile_short_circuits_on_duplicate_md5sum_and_associates_categories(): void
    {
        ...
        $result = new UploadService($this->currentLogger, $this->storageRegistry, \Piwigo\PluginConfig\EventDispatcher::get(), $this->configService, $this->entityManager, $this->activityService, $this->metadataService, $this->imageService)->addUploadedFile(
            $source,
            $this->urlService,
            'dup.jpg',
            categories: [2],
    ...
    {
        $service = new UploadService($this->currentLogger, $this->storageRegistry, \Piwigo\PluginConfig\EventDispatcher::get(), $this->configService, $this->entityManager, $this->activityService, $this->metadataService, $this->imageService);
    ...
    public function test_addUploadedFile_throws_when_the_given_image_id_does_not_exist(): void
    {
        ...
        $threw = null;
        try {
            new UploadService($this->currentLogger, $this->storageRegistry, \Piwigo\PluginConfig\EventDispatcher::get(), $this->configService, $this->entityManager, $this->activityService, $this->metadataService, $this->imageService)->addUploadedFile($source, $this->urlService, 'orphan.png', image_id: 999_999);
    ...
    public function test_addUploadedFile_resolves_a_non_standard_extension_via_the_finfo_fallback_when_all_types_allowed(): void
    {
        ...
        $imageId = new UploadService($this->currentLogger, $this->storageRegistry, \Piwigo\PluginConfig\EventDispatcher::get(), $this->configService, $this->entityManager, $this->activityService, $this->metadataService, $this->imageService)->addUploadedFile($source, $this->urlService, 'archive.zip');
        $id = $imageId;
        $this->imageIdsToDelete[] = $id;
    ...
    public function test_addUploadedFile_resizes_the_original_when_it_exceeds_the_configured_max_dimensions(): void
    {
        ...
        $imageId = new UploadService($this->currentLogger, $this->storageRegistry, \Piwigo\PluginConfig\EventDispatcher::get(), $this->configService, $this->entityManager, $this->activityService, $this->metadataService, $this->imageService)->addUploadedFile($source, $this->urlService, 'big.jpg');
        $id = $imageId;
        $this->imageIdsToDelete[] = $id;
    ...
    public function test_addUploadedFile_stores_the_representative_ext_when_an_upload_file_handler_matches(): void
    {
        ...
        try {
            ...
            $imageId = new UploadService($this->currentLogger, $this->storageRegistry, \Piwigo\PluginConfig\EventDispatcher::get(), $this->configService, $this->entityManager, $this->activityService, $this->metadataService, $this->imageService)->addUploadedFile($pdf, $this->urlService, 'document.pdf');
            $id = $imageId;
            $this->imageIdsToDelete[] = $id;
    ...
    public function test_addUploadedFile_rejects_a_mismatched_svg_mime_type_and_deletes_the_source_file(): void
    {
        ...
        $threw = null;
        try {
            new UploadService($this->currentLogger, $this->storageRegistry, \Piwigo\PluginConfig\EventDispatcher::get(), $this->configService, $this->entityManager, $this->activityService, $this->metadataService, $this->imageService)->addUploadedFile($source, $this->urlService, 'fake.png');
        } catch (ImageProcessingException $e) {
            $threw = $e;
        }
    ...
    public function test_addUploadedFile_rejects_an_extension_absent_from_fileExtensions_even_when_all_types_are_allowed(): void
    {
        ...
        $threw = null;
        try {
            new UploadService($this->currentLogger, $this->storageRegistry, \Piwigo\PluginConfig\EventDispatcher::get(), $this->configService, $this->entityManager, $this->activityService, $this->metadataService, $this->imageService)->addUploadedFile($source, $this->urlService, 'payload.exe');
        } catch (ImageProcessingException $e) {
            $threw = $e;
        }
    ...
    public function test_addUploadedFile_rejects_a_forbidden_file_type_and_deletes_the_source_file(): void
    {
        ...
        $threw = null;
        try {
            new UploadService($this->currentLogger, $this->storageRegistry, \Piwigo\PluginConfig\EventDispatcher::get(), $this->configService, $this->entityManager, $this->activityService, $this->metadataService, $this->imageService)->addUploadedFile($source, $this->urlService, 'notes.txt');
        } catch (ImageProcessingException $e) {
            $threw = $e;
        }
    ...
    public function test_add_uploaded_file_add_to_categories_flips_lounge_active_once_the_photo_count_reaches_the_threshold(): void
    {
        ...
        $imageId = new UploadService($this->currentLogger, $this->storageRegistry, \Piwigo\PluginConfig\EventDispatcher::get(), $this->configService, $this->entityManager, $this->activityService, $this->metadataService, $this->imageService)->addUploadedFile($source, $this->urlService, 'threshold.png');
    ...
    public function test_add_uploaded_file_add_to_categories_associates_a_new_photo_to_the_given_categories_when_lounge_is_inactive(): void
    {
        ...
        $imageId = new UploadService($this->currentLogger, $this->storageRegistry, \Piwigo\PluginConfig\EventDispatcher::get(), $this->configService, $this->entityManager, $this->activityService, $this->metadataService, $this->imageService)->addUploadedFile($source, $this->urlService, 'associate.png', categories: [1]);
        $id = $imageId;
        $this->imageIdsToDelete[] = $id;
