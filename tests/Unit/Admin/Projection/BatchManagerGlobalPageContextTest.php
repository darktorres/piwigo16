...
test('toArray flattens every fixed property, and omits associated_tags/navbar/thumb_params when null', function (): void {
    $context = new BatchManagerGlobalPageContext(
        ...
        delDerivativesTypes: ['sq' => 'Square'],
        generateDerivativesTypes: ['sq' => 'Square'],
        navbar: null,
        thumbParams: null,
        nbThumbsPage: 0,
        nbThumbsSet: 0,
    ...
    expect($context->toArray())->toBe([
        ...
        'level_options' => [0 => 'Everybody'],
        'level_options_selected' => 0,
        'used_metadata' => 'iptc, exif',
        'del_derivatives_types' => ['sq' => 'Square'],
        'generate_derivatives_types' => ['sq' => 'Square'],
        'nb_thumbs_page' => 0,
        'nb_thumbs_set' => 0,
...
test('toArray includes associated_tags/navbar when set', function (): void {
    $context = new BatchManagerGlobalPageContext(
        inCaddie: true,
        associatedTags: [['id' => 1, 'name' => 'sunset', 'url_name' => 'sunset', 'lastmodified' => '2026-08-08', 'counter' => 3]],
        dateCreation: '2026-08-08 00:00:00',
        levelOptions: [0 => 'Everybody'],
        levelOptionsSelected: 0,
        usedMetadata: 'iptc, exif',
