 ...
 * shape as AdminAccessorTest.php/CoreDomainAccessorTest.php: all 4
 * accessors' own \LogicException guards had zero coverage even though
 * the happy path is exercised elsewhere (this class's own real callers,
 * per its own docblock).
 ...
 * pattern as AdminAccessorTest.php's own docblock -- none of these 4
...
test('every accessor returns its real, correctly-typed instance from a real container, without throwing', function (): void {
    ...
    // one of the 4 calls below completes without hitting its internal
