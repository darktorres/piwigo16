...
test('toArray includes chronology_views when set', function (): void {
    $context = new CalendarChronologyPageContext(
        ...
        chronologyTitle: '<a href="/index.php">2026</a>',
        chronologyNavigationBars: [],
        chronologyViews: [['VALUE' => '/index.php?/calendar', 'CONTENT' => 'monthly - calendar', 'SELECTED' => true]],
    );

    expect($context->toArray()['chronology_views'])->toBe([['VALUE' => '/index.php?/calendar', 'CONTENT' => 'monthly - calendar', 'SELECTED' => true]]);
});
