...
test('toArray flattens every property to its real Smarty template variable name', function (): void {
    ...
    $context = new CommentsPageContext(
        ...
        fKeyword: 'sunset',
        fAuthor: 'jane',
        sinceOptions: [1 => 'today', 2 => 'last 7 days'],
        sinceOptionsSelected: 4,
        sortByOptions: ['date' => 'comment date'],
        sortByOptionsSelected: 'date',
        sortOrderOptions: ['DESC' => 'descending'],
        sortOrderOptionsSelected: 'DESC',
        itemNumberOptions: [5 => 5, 'all' => 'all'],
    ...
    expect($context->toArray())->toBe([
        ...
        'F_KEYWORD' => 'sunset',
        'F_AUTHOR' => 'jane',
        'since_options' => [1 => 'today', 2 => 'last 7 days'],
        'since_options_selected' => 4,
        'sort_by_options' => ['date' => 'comment date'],
        'sort_by_options_selected' => 'date',
        'sort_order_options' => ['DESC' => 'descending'],
        'sort_order_options_selected' => 'DESC',
        'item_number_options' => [5 => 5, 'all' => 'all'],
