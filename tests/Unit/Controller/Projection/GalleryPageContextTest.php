...
$makeContext = fn (
    ...
    ?string $uModeCreated = null,
    ?string $uModePosted = null,
    ...
    title: 'Holidays',
    nbItems: 42,
    uModeNormal: $uModeNormal,
    uModeFlat: $uModeFlat,
    uModeCreated: $uModeCreated,
    uModePosted: $uModePosted,
    searchInSetButton: $searchInSetButton,
    searchInSetAction: $searchInSetAction,
    searchInSetUrl: $searchInSetUrl,
    selectRelatedTags: $selectRelatedTags,
);
