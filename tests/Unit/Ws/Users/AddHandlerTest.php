...
use Piwigo\Ws\Users\AddHandler;
use Piwigo\Ws\WsErrorResponse;

/**
 * Piwigo\Ws\Users\AddHandler -- `pwg.users.add` (admin_only). Resolved via
 ...
 * real user registration needs a real DB write and is not attempted here.
 */
function pwgUsersAddHandlerTestSubject(): AddHandler
{
...
test('returns a 403 WsErrorResponse when a submitted pwg_token does not match the real CSRF token', function (): void {
    $handler = pwgUsersAddHandlerTestSubject();
