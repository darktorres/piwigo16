...
use Piwigo\Ws\Users\SetInfoHandler;
use Piwigo\Ws\WsErrorResponse;

/**
 * Piwigo\Ws\Users\SetInfoHandler -- `pwg.users.setInfo` (admin_only).
 ...
 * very first check -- the real update needs real user rows and is not
 * attempted here.
 */
function pwgUsersSetInfoHandlerTestSubject(): SetInfoHandler
{
...
test('returns a 403 WsErrorResponse when a submitted pwg_token does not match the real CSRF token', function (): void {
    $handler = pwgUsersSetInfoHandlerTestSubject();
