<div class="navigationButtons"{if isset($next)} data-next="{$next.U_IMG}"{/if}{if isset($previous)} data-previous="{$previous.U_IMG}"{/if}{if isset($first)} data-first="{$first.U_IMG}"{/if}{if isset($last)} data-last="{$last.U_IMG}"{/if}{if isset($U_UP) and !isset($slideshow)} data-up="{$U_UP}"{/if}{if isset($slideshow.U_START_PLAY)} data-slideshow-play="{$slideshow.U_START_PLAY}"{/if}{if isset($slideshow.U_STOP_PLAY)} data-slideshow-pause="{$slideshow.U_STOP_PLAY}"{/if}>
