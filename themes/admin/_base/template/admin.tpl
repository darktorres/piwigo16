{combine_script id='admin' load='footer' path='themes/admin/_base/js/admin.js'}
...
{combine_script id='admin_help_glightbox' load='footer' path='themes/admin/_base/js/admin_help_glightbox.js'}
