...
{combine_script id='album_notification' load='footer' path='themes/admin/_base/js/album_notification.js'}

{combine_css path="themes/admin/_base/css/pages/album_notification.css"}
