...
{combine_script id='cat_search' load='footer' path='themes/admin/_base/js/cat_search.js'}
{combine_script id='albums' load='footer' path='themes/admin/_base/js/albums.js'}
...
{combine_css path="themes/admin/_base/css/pages/albums.css"}