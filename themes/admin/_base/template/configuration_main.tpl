...
{combine_script id='configuration_main' load='footer' require='common' path='themes/admin/_base/js/configuration_main.js'}
  ...
  <fieldset class="mainConf">
    ...
    <ul>
      ...
      <li>
        ...
        <span class="icon-help-circled tiptip-with-img show-mobile-app-banner-tooltip" title="{'Displays a banner to install or open the official Piwigo app'|translate}<br><img src='themes/admin/_base/images/piwigo_app_banner.jpg' style='width:100%;margin-top:5px;'>"></span>
      </li>
