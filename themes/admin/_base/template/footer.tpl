...
<div id="footer">
  <div>
    <a class="externalLink tiptip piwigo-logo" href="{$PHPWG_URL}" title="{'Visit Piwigo project website'|translate}"><img src="themes/admin/_base/images/piwigo-grey.svg"></a>
...
{combine_script id='admin_footer' load='footer' path='themes/admin/_base/js/admin_footer.js'}
