...
<link rel="stylesheet" type="text/css" href="{$ROOT_URL}themes/admin/_base/fonts/open-sans/open-sans.css">

{strip}
{combine_css path="themes/admin/_base/fontello/css/fontello.css" order=-10}
{assign "theme_id" ""}
