{combine_script id='ajax' load='footer' path='themes/admin/_base/js/maintenance.js'}
{combine_script id='activated_plugin_list' load='footer' path='themes/admin/_base/js/maintenance_env.js'}
...
{combine_css path="themes/admin/_base/css/pages/maintenance-env.css"}