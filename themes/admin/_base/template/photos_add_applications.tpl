...
{combine_script id='photos_add_applications_glightbox' load='footer' path='themes/admin/_base/js/photos_add_applications_glightbox.js'}

{combine_css path="themes/admin/_base/css/pages/photos-add-applications.css"}
