...
{combine_script id='add_photo' load='footer' path='themes/admin/_base/js/photos_add_direct.js'}

{combine_css path="themes/admin/_base/css/pages/photos_add_direct.css"}
