...
{combine_script id='picture_modify' load='footer' path='themes/admin/_base/js/picture_modify.js'}
...
{combine_css path="themes/admin/_base/css/pages/picture_modify.css"}
