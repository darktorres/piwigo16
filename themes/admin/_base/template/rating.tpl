...
{combine_script id='rating_admin' load='footer' require='common' path='themes/admin/_base/js/rating_admin.js'}

{combine_css path="themes/admin/_base/css/pages/rating.css"}
