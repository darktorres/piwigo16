...
{combine_script id='rating_user' load='footer' require='common' path='themes/admin/_base/js/rating_user.js'}

{combine_css path="themes/admin/_base/css/pages/rating_user.css"}
