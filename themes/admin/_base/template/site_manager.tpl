...
{combine_script id='site_manager' load='footer' require='common' path='themes/admin/_base/js/site_manager.js'}
{combine_css path="themes/admin/_base/css/pages/site_manager.css"}
