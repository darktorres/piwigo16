...
{combine_script id='updates_pwg' load='footer' path='themes/admin/_base/js/updates_pwg.js'}

{combine_css path="themes/admin/_base/css/pages/updates-pwg.css"}
...
<p class="autoupdate_bar" hidden>&nbsp; {'Update in progress...'|@translate}<br><img src="themes/admin/_base/images/ajax-loader-bar.gif"></p>
