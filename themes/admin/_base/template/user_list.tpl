...
{combine_script id='common' load='header' path='themes/admin/_base/js/common.js'}

{combine_css path="themes/admin/_base/fontello/css/animation.css" order=10} {* order 10 is required, see issue 1080 *}

<script id="pwg-page-data" type="application/json">{$page_data_json}</script>

{combine_script id='user_list' load='footer' path='themes/admin/_base/js/user_list.js'}
...
{combine_css path="themes/admin/_base/css/pages/user-list.css"}
