...
const title_msg = pwg_getPageString('Are you sure you want to restore to default settings?');
...
(function(){
  ...
  jQuery(".cropToggle").click(function() {
    const labelBoxWidth = jQuery(this).parents('table.sizeEditForm').find('td.sizeEditWidth');
    const labelBoxHeight = jQuery(this).parents('table.sizeEditForm').find('td.sizeEditHeight');
