...
jQuery(".std_pgs_mini_previews img").click(function () {
  ...
  const preview_light_path =
    "themes/standard_pages/skins/light-" + $(this).attr("id") + ".jpg";
  const preview_dark_path =
    "themes/standard_pages/skins/dark-" + $(this).attr("id") + ".jpg";

  jQuery(".std_pgs_selected_preview img#preview-light").attr(
    "src",
    preview_light_path,
  );
  jQuery(".std_pgs_selected_preview img#preview-dark").attr(
    "src",
    preview_dark_path,
  );
});
