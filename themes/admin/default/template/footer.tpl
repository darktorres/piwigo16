...
<div id="footer">
  <div>
    <a class="externalLink tiptip piwigo-logo" href="{$APP_URL}" title="{'Visit Piwigo project website'|translate}"><img src="themes/admin/default/images/piwigo-grey.svg"></a>
...
{if isset($VITALS_SCRIPT_URL)}
<script type="module" src="{$VITALS_SCRIPT_URL}"></script>
{/if}
