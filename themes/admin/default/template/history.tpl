...
{combine_script id='history' load='footer' path='themes/admin/default/js/history.js'}
...
{combine_script id='jquery.geoip' load='async' path='themes/admin/default/js/jquery.geoip.js'}
