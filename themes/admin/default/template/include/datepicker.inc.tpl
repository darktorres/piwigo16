...
{if $ROOT_PATH|@cat:$datepicker_language|@file_exists}
...
{combine_script id='datepicker' load=$load_mode require=$require path='themes/admin/default/js/datepicker.js'}
