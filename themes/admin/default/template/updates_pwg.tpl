...
<p class="autoupdate_bar" style="display:none;">&nbsp; {'Update in progress...'|@translate}<br><img src="themes/admin/default/images/ajax-loader-bar.gif"></p>
<p><input type="hidden" name="upgrade_to" value="{$UPGRADE_TO}"><input type="hidden" name="pwg_token" value="{$CSRF_TOKEN}"></p>
</form>
{/if}
