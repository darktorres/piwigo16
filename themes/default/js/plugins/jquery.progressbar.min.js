/*
 * jQuery Progress Bar plugin -- Version 2.0 (06/22/2009), requires jQuery
 * v1.2.1 or later.
 *
 ...
 * -- no npm package, GitHub repo, or personal site for Gary Teo/t.wits.sg
 * could be found anywhere. This minified build is the file actually served
 * (BatchManagerGlobalView registers it); it shipped with no header at all,
 * so the attribution above is carried here rather than in the unminified
 * source, which nothing ever loaded and which was removed. That source is
 * still in git history if the readable form is ever needed.
 */
