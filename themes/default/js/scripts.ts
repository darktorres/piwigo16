...
function pwgAddEventListener(elem: EventTarget, evt: string, fn: EventListenerOrEventListenerObject): void
{
	if (typeof window.addEventListener !== 'undefined')
		elem.addEventListener(evt, fn, false);
	else
		(elem as any).attachEvent('on'+evt, fn);
}
...
function pwg_checkPasswordMatch(pass1Id: string, pass2Id: string, errorId: string): void
{
