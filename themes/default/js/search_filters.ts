...
const str_empty_search_top_alt = pwg_getPageString('Fill in the filters to start a search');
const str_empty_search_bot_alt = pwg_getPageString('Pre-established filters are proposed, but you can add or remove them using the "Choose filters" button.');
...
// <!-- sliders config -->
const sliders: { filesizes?: PwgSliderConfig; heights?: PwgSliderConfig; widths?: PwgSliderConfig } = {};
...
const show_filter_ratings = (typeof show_filter_ratings_value === "undefined") ? false : show_filter_ratings_value;
