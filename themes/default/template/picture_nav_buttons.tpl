	...
	{if $DISPLAY_NAV_BUTTONS or isset($slideshow)}
		{if isset($slideshow)}
			{if isset($slideshow.U_INC_PERIOD)}
				<a href="{$slideshow.U_INC_PERIOD}" title="{'Reduce slideshow speed'|translate}"
					...
					<span class="pwg-icon pwg-icon-clock-minus"></span><span
						class="pwg-button-text">{'Reduce slideshow speed'|translate}</span>
				</a>
			{else}
			...
			{if isset($slideshow.U_DEC_PERIOD)}
				<a href="{$slideshow.U_DEC_PERIOD}" title="{'Accelerate slideshow speed'|translate}"
					class="pwg-state-default pwg-button">
					<span class="pwg-icon pwg-icon-clock-plus"></span><span
						class="pwg-button-text">{'Accelerate slideshow speed'|translate}</span>
				</a>
			{else}
				<span class="pwg-state-disabled pwg-button">
					<span class="pwg-icon pwg-icon-clock-plus"></span><span
		...
		{if isset($slideshow.U_START_REPEAT)}
			<a href="{$slideshow.U_START_REPEAT}" title="{'Repeat the slideshow'|translate}"
				class="pwg-state-default pwg-button">
				<span class="pwg-icon pwg-icon-repeat-play"></span><span
					class="pwg-button-text">{'Repeat the slideshow'|translate}</span>
			</a>
		{/if}
		{if isset($slideshow.U_STOP_REPEAT)}
			<a href="{$slideshow.U_STOP_REPEAT}" title="{'Not repeat the slideshow'|translate}"
				class="pwg-state-default pwg-button">
				<span class="pwg-icon pwg-icon-repeat-stop"></span><span
					class="pwg-button-text">{'Not repeat the slideshow'|translate}</span>
			</a>
		{/if}
		{*<!--{if isset($first)}
...
{/if}-->*}
		...
		{if isset($slideshow.U_START_PLAY)}
			<a href="{$slideshow.U_START_PLAY}" title="{'Play of slideshow'|translate}" class="pwg-state-default pwg-button">
				<span class="pwg-icon pwg-icon-play"></span><span
					class="pwg-button-text">{'Play of slideshow'|translate}</span>
			</a>
		{/if}
		{if isset($slideshow.U_STOP_PLAY)}
			<a href="{$slideshow.U_STOP_PLAY}" title="{'Pause of slideshow'|translate}" class="pwg-state-default pwg-button">
				<span class="pwg-icon pwg-icon-pause"></span><span
					class="pwg-button-text">{'Pause of slideshow'|translate}</span>
			</a>
		{/if}
		{if isset($next)}
			<a href="{$next.U_IMG}" title="{'Next'|translate} : {$next.TITLE_ESC}"
				class="pwg-state-default pwg-button pwg-button-icon-right">
