    ...
    jQuery("li>a>img", jQuery("#thumbnails")).hoverIntent({
        ...
        over: function () {
            ...
            $pop.css({
                ...
                .html(
                    '<div><a href="' +
                        $src_img.parent("a").attr("href") +
                        '"><img src="' +
                        $src_img.attr("src") +
                        '" style="width:100%;height:' +
                        data.ih +
                        'px"></a></div>' +
                        '<div style="overflow:hidden;height:5em;background-color:#000">' +
                        $(".popDesc", $src_img.closest("li")).html() +
                        "</div>",
                )
                .show()
                .animate(
