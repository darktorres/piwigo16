  ...
  static function mobile_link()
  {
    ...
    if ( !empty($conf['mobile_theme']) && (functions::get_device() != 'desktop' || functions::mobile_theme()))
    {
      $template->assign(array(
                              'TOGGLE_MOBILE_THEME_URL' => functions_url::add_url_params(htmlspecialchars($_SERVER['REQUEST_URI']),array('mobile' => functions::mobile_theme() ? 'false' : 'true')),
        ));
    }
  }

  static function add_menu_on_public_pages() { 
