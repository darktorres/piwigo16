//! Auto-ported Olympus CameraType lookup (Olympus.pm %olympusCameraTypes).

/// Map an Olympus camera type code to its model name.
pub fn olympus_camera_type(code: &str) -> Option<&'static str> {
    Some(match code {
        "D4028" => "X-2,C-50Z",
