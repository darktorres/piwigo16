//! Auto-extracted PLUS LDF MediaMatrix vocabulary (from PLUS.pm %mediaMatrix).
//! Maps Media Matrix ID codes to human-readable descriptions.

pub fn media_matrix(code: &str) -> Option<&'static str> {
    Some(match code {
        "1IAA" => "1 Usage Item:",
        "1IAB" => "2 Usage Items:",
        "1IAC" => "3 Usage Items:",
