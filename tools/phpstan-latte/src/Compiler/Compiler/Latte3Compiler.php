...
final class Latte3Compiler extends AbstractCompiler
{
    ...
    public function compile(string $templateContent, ?string $actualClass, string $context = ''): string
    {
        ...
        // Latte 3.1 split the old single-call generate() into two: buildClass()
        // applies the AST passes and stages the class members; generateCode()
        // emits the PHP source. Latte 3.0 had it as one method.
