...
$permissionServiceCtor = 'new \Piwigo\Permission\PermissionService(new \Piwigo\Permission\PermissionRepository(\Piwigo\Db\DbConnection::build()), new \Piwigo\Group\GroupRepository(\Piwigo\Db\DbConnection::build()), new \Piwigo\Category\CategoryRepository(\Piwigo\Db\DbConnection::build()))';
