...
array(
  ...
  'files' => array('src/Piwigo/Menu/BlockManager.php (BlockManager::apply)'),
...
array(
  ...
  'files' => array('src/Piwigo/Menu/BlockManager.php (BlockManager::prepare_display)'),
),
array(
  'name' => 'blockmanager_register_blocks',
  'type' => 'trigger_notify',
  'vars' => array('object', 'menu'),
  'files' => array('src/Piwigo/Menu/BlockManager.php (BlockManager::load_registered_blocks)'),
...
array(
  ...
  'files' => array('src/Piwigo/Template/Template.php (Template::flush)'),
),
array(
  'name' => 'combined_css_postfilter',
  'type' => 'trigger_change',
  'vars' => array('string', 'css'),
  'files' => array('src/Piwigo/Template/Template.php (Template::process_css)'),
),
array(
  'name' => 'combined_script',
  'type' => 'trigger_change',
  'vars' => array('string', 'ret', 'string', 'script'),
  'files' => array('src/Piwigo/Template/Template.php (Template::make_script_src)'),
),
array(
...
array(
  ...
  'files' => array('src/Piwigo/Template/FileCombiner.php (FileCombiner::process_combinable)'),
  'infos' => 'New in 2.6.',
),
array(
