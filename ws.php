...
if (!\Piwigo\Core\Config::allowWebServices()) {
...
function ws_addDefaultMethods(array $arr): void
{
    ...
    $f_params = [
      'f_min_rate' => ['default' => null,
                            'type' => WS_TYPE_FLOAT],
      'f_max_rate' => ['default' => null,
                            'type' => WS_TYPE_FLOAT],
      'f_min_hit' =>  ['default' => null,
                            'type' => WS_TYPE_INT | WS_TYPE_POSITIVE],
      'f_max_hit' =>  ['default' => null,
                            'type' => WS_TYPE_INT | WS_TYPE_POSITIVE],
      'f_min_ratio' => ['default' => null,
                             'type' => WS_TYPE_FLOAT | WS_TYPE_POSITIVE],
      'f_max_ratio' => ['default' => null,
                             'type' => WS_TYPE_FLOAT | WS_TYPE_POSITIVE],
      'f_max_level' => ['default' => null,
                             'type' => WS_TYPE_INT | WS_TYPE_POSITIVE],
    ...
    $service->addMethod(
        ...
        'offset' => ['default' => 0,
                        'type' => WS_TYPE_INT | WS_TYPE_POSITIVE],
        'uid' => ['default' => null, 'type' => WS_TYPE_ID],
        'date_min' => ['default' => null],
        'date_max' => ['default' => null],
        'id' => ['default' => null, 'type' => WS_TYPE_ID],
        'object' => ['default' => null],
        'action' => ['default' => null],
        ],
        'Returns general informations.',
    ...
    $service->addMethod(
        ...
        array_merge([
          ...
          'per_page' =>   ['default' => 100,
                                'maxValue' => \Piwigo\Core\Config::wsMaxImagesPerPage(),
                                'type' => WS_TYPE_INT | WS_TYPE_POSITIVE],
          'page' =>       ['default' => 0,
                                'type' => WS_TYPE_INT | WS_TYPE_POSITIVE],
          'order' =>      ['default' => null,
...
<br><b>order</b> comma separated fields for sorting',
    ...
    $service->addMethod(
        ...
        array_merge([
          ...
          'ids' =>          ['default' => null,
                                  'flags' => WS_PARAM_FORCE_ARRAY,
                                  'type' => WS_TYPE_ID],
          'max_urls' =>     ['default' => 200,
                                  'type' => WS_TYPE_INT | WS_TYPE_POSITIVE],
          'prev_page' =>    ['default' => null,
                                  'type' => WS_TYPE_INT | WS_TYPE_POSITIVE],
          ], $f_params),
    ...
    $service->addMethod(
        ...
        [
          ...
          'author' =>   ['default' => is_a_guest() ? 'guest' : $user['username']],
          'content' =>  [],
          'key' =>      [],
          ],
    ...
    $service->addMethod(
        ...
        [
          ...
          'comments_page' =>      ['default' => 0,
                                        'type' => WS_TYPE_INT | WS_TYPE_POSITIVE],
          'comments_per_page' =>  ['default' => \Piwigo\Core\Config::nbCommentPage(),
                                        'maxValue' => 2 * \Piwigo\Core\Config::nbCommentPage(),
                                        'type' => WS_TYPE_INT | WS_TYPE_POSITIVE],
          ],
    ...
    $service->addMethod(
        ...
        [
          'image_id' => ['flags' => WS_PARAM_FORCE_ARRAY,
                              'type' => WS_TYPE_ID],
          'level' =>    ['maxValue' => max(\Piwigo\Core\Config::availablePermissionLevels()),
                              'type' => WS_TYPE_INT | WS_TYPE_POSITIVE],
          ],
    ...
    $service->addMethod(
        ...
        [
          'format_id' => ['type' => WS_TYPE_ID, 'default' => null, 'flags' => WS_PARAM_ACCEPT_ARRAY],
          'pwg_token' =>  [],
          ],
        'Remove a format',
        $ws_functions_root . 'pwg.images.php',
    ...
    $service->addMethod(
        ...
        'ws_images_setRank',
        [
          'image_id'    => ['type' => WS_TYPE_ID,'flags' => WS_PARAM_FORCE_ARRAY],
          'category_id' => ['type' => WS_TYPE_ID],
          'rank'        => ['type' => WS_TYPE_INT | WS_TYPE_POSITIVE | WS_TYPE_NOTNULL, 'default' => null],
          ],
...
<li>you are supposed to provide the list of all image_ids belonging to the album.
    ...
    $service->addMethod(
        ...
        [
          ...
          'category_id' => ['type' => WS_TYPE_ID],
          'action'      => ['default' => 'associate', 'info' => 'associate/dissociate/move'],
          'pwg_token'   => [],
          ],
    ...
    $service->addMethod(
        ...
        'ws_rates_delete',
        [
          'user_id' =>      ['type' => WS_TYPE_ID],
          'anonymous_id' => ['default' => null],
          'image_id' =>     ['flags' => WS_PARAM_OPTIONAL, 'type' => WS_TYPE_ID],
          ],
    ...
    $service->addMethod(
        ...
        array_merge([
          'tag_id' =>       ['default' => null,
                                  'flags' => WS_PARAM_FORCE_ARRAY,
                                  'type' => WS_TYPE_ID],
          'tag_url_name' => ['default' => null,
                                  'flags' => WS_PARAM_FORCE_ARRAY],
          'tag_name' =>     ['default' => null,
                                  'flags' => WS_PARAM_FORCE_ARRAY],
...
<br>pwg.images.addChunk must have been called before (maybe several times).',
    ...
    $service->addMethod(
        ...
        [
          ...
          'level' =>              ['default' => 0,
                                        'maxValue' => max(\Piwigo\Core\Config::availablePermissionLevels()),
                                        'type' => WS_TYPE_INT | WS_TYPE_POSITIVE],
...
<br>Set the form encoding to "form-data".',
    ...
    $service->addMethod(
        ...
        [
          'username' => ['flags' => WS_PARAM_OPTIONAL],
          'password' => ['default' => null, 'flags' => WS_PARAM_OPTIONAL],
          'chunk' => ['type' => WS_TYPE_INT | WS_TYPE_POSITIVE],
          'chunk_sum' => [],
          'chunks' => ['type' => WS_TYPE_INT | WS_TYPE_POSITIVE],
          'original_sum' => [],
          'category' => ['default' => null, 'flags' => WS_PARAM_FORCE_ARRAY, 'type' => WS_TYPE_ID],
          'filename' => [],
          'name' => ['default' => null],
          'author' => ['default' => null],
          'comment' => ['default' => null],
          'date_creation' => ['default' => null],
          'level' => ['default' => 0, 'maxValue' => max(\Piwigo\Core\Config::availablePermissionLevels()), 'type' => WS_TYPE_INT | WS_TYPE_POSITIVE],
...
<br>Requires <b>admin</b> credentials: either with username/password or header authorization with api key.',
    ...
    $service->addMethod(
        ...
        'ws_images_delete',
        [
          'image_id' =>   ['flags' => WS_PARAM_ACCEPT_ARRAY],
          'pwg_token' =>  [],
          ],
        'Deletes image(s).',
        $ws_functions_root . 'pwg.images.php',
    ...
    $service->addMethod(
        ...
        'ws_images_setMd5sum',
        [
          'block_size' => ['default' => \Piwigo\Core\Config::checksumComputeBlocksize(), 'type' => WS_TYPE_INT | WS_TYPE_POSITIVE],
          'pwg_token' =>  [],
          ],
    ...
    $service->addMethod(
        ...
        [
          'image_id' => ['flags' => WS_PARAM_ACCEPT_ARRAY, 'info' => 'Comma separated ids or array of id'],
          'pwg_token' =>  [],
          ],
    ...
    $service->addMethod(
        ...
        [
          'block_size' => ['default' => 1000, 'type' => WS_TYPE_INT | WS_TYPE_POSITIVE],
          'pwg_token' =>  [],
          ],
    ...
    $service->addMethod(
        ...
        [
          ...
          'recursive' => [
            'default' => true,
            'type' => WS_TYPE_BOOL],
          'additional_output' =>    ['default' => null,
    ...
    $service->addMethod(
        ...
        [
          ...
          'status' =>       ['default' => null,
                                  'info' => 'public, private'],
          'commentable' =>  ['default' => true,
                                  'type' => WS_TYPE_BOOL],
          'position' =>     ['default' => null, 'info' => 'first, last'],
          'pwg_token' => ['flags' => WS_PARAM_OPTIONAL],
          ],
    ...
    $service->addMethod(
        ...
        [
          'category_id' =>           ['flags' => WS_PARAM_ACCEPT_ARRAY],
...
(default mode, only deletes photos linked to no other album) or "force_delete" (delete all photos, even those linked to other albums)',
    ...
    $service->addMethod(
        ...
        [
          'category_id' =>  ['flags' => WS_PARAM_ACCEPT_ARRAY],
          'parent' =>       ['type' => WS_TYPE_INT | WS_TYPE_POSITIVE],
          'pwg_token' =>    [],
          ],
        'Move album(s).
<br>Set parent as 0 to move to gallery root. Only virtual categories can be moved.',
    ...
    $service->addMethod(
        ...
        'ws_tags_merge',
        [
          'destination_tag_id' => ['type' => WS_TYPE_ID,
            'info' => 'Is not necessarily part of groups to merge'],
          'merge_tag_id' => ['flags' => WS_PARAM_FORCE_ARRAY,
            'type' => WS_TYPE_ID],
          'pwg_token' => [],
          ],
...
<br>Don\'t use "thumbnail_sum" and "high_sum", these parameters are here for backward compatibility.',
    ...
    $service->addMethod(
        ...
        [
          'image_id' => ['default' => null, 'flags' => WS_PARAM_ACCEPT_ARRAY],
          'pwg_token' => [],
          'category_id' => ['type' => WS_TYPE_ID],
          ],
...
<br><b>pwg_token</b> required if you want to use HTML in name/comment/author.',
    ...
    $service->addMethod(
        ...
        [
          'category_id' =>  ['type' => WS_TYPE_ID,
                                  'flags' => WS_PARAM_FORCE_ARRAY],
          'rank' =>         ['type' => WS_TYPE_INT | WS_TYPE_POSITIVE | WS_TYPE_NOTNULL,
                                  'flags' => WS_PARAM_OPTIONAL],
          ],
    ...
    $service->addMethod(
        ...
        [
          ...
          'per_page' => ['default' => 100,
                              'maxValue' => \Piwigo\Core\Config::wsMaxUsersPerPage(),
                              'type' => WS_TYPE_INT | WS_TYPE_POSITIVE],
          'page' =>     ['default' => 0,
                              'type' => WS_TYPE_INT | WS_TYPE_POSITIVE],
          'order' =>    ['default' => 'name',
    ...
    $service->addMethod(
        ...
        'ws_groups_delete',
        [
          'group_id' => ['flags' => WS_PARAM_FORCE_ARRAY,
                              'type' => WS_TYPE_ID],
          'pwg_token' =>  [],
          ],
    ...
    $service->addMethod(
        ...
        'ws_groups_setInfo',
        [
          'group_id' =>   ['type' => WS_TYPE_ID],
          'name' =>       ['flags' => WS_PARAM_OPTIONAL],
          'is_default' => ['flags' => WS_PARAM_OPTIONAL,
                                'type' => WS_TYPE_BOOL],
          'pwg_token' => [],
          ],
    ...
    $service->addMethod(
        ...
        [
          'group_id' => ['type' => WS_TYPE_ID],
          'user_id' =>  ['flags' => WS_PARAM_FORCE_ARRAY,
                              'type' => WS_TYPE_ID],
          'pwg_token' => [],
          ],
    ...
    $service->addMethod(
        ...
        'ws_groups_merge',
        [
          'destination_group_id' => ['type' => WS_TYPE_ID,
            'info' => 'Is not necessarily part of groups to merge'],
          'merge_group_id' => ['flags' => WS_PARAM_FORCE_ARRAY,
            'type' => WS_TYPE_ID],
          'pwg_token' => [],
          ],
    ...
    $service->addMethod(
        ...
        'ws_users_getList',
        [
          'user_id' =>    ['flags' => WS_PARAM_OPTIONAL | WS_PARAM_FORCE_ARRAY,
                                'type' => WS_TYPE_ID],
          'username' =>   ['flags' => WS_PARAM_OPTIONAL,
                                'info' => 'Use "%" as wildcard.'],
          ...
          'exclude' =>    ['flags' => WS_PARAM_OPTIONAL | WS_PARAM_FORCE_ARRAY,
                                'type' => WS_TYPE_ID,
                                'info' => 'Expects a user_id as value.'],
          'display' =>    ['default' => 'basics',
                                'info' => 'Comma saparated list (see method description)'],
          'filter' =>     ['flags' => WS_PARAM_OPTIONAL,
                                'info' => 'Filter by username, email, group'],
          'min_register' => ['flags' => WS_PARAM_OPTIONAL,
                                   'info' => 'See method description'],
          'max_register' => ['flags' => WS_PARAM_OPTIONAL,
                                  'info' => 'See method description'],
          ],
...
<b>min_register</b> and <b>max_register</b> filter users by their registration date expecting format "YYYY" or "YYYY-mm" or "YYYY-mm-dd".',
    ...
    $service->addMethod(
        ...
        [
          ...
          'password' => ['default' => null],
          'password_confirm' => ['flags' => WS_PARAM_OPTIONAL],
          'email' =>    ['default' => null],
          'send_password_by_mail' => ['default' => false, 'type' => WS_TYPE_BOOL],
          'pwg_token' => [],
          ],
    ...
    $service->addMethod(
        ...
        [
          'user_id' =>          ['flags' => WS_PARAM_FORCE_ARRAY,
                                      'type' => WS_TYPE_ID],
          'username' =>         ['flags' => WS_PARAM_OPTIONAL],
          'password' =>         ['flags' => WS_PARAM_OPTIONAL],
          'email' =>            ['flags' => WS_PARAM_OPTIONAL],
          ...
          'group_id' => ['flags' => WS_PARAM_OPTIONAL | WS_PARAM_FORCE_ARRAY, 'type' => WS_TYPE_INT],
          // bellow are parameters removed in a future version
          'nb_image_page' =>    ['flags' => WS_PARAM_OPTIONAL,
                                      'type' => WS_TYPE_INT | WS_TYPE_POSITIVE | WS_TYPE_NOTNULL],
          'recent_period' =>    ['flags' => WS_PARAM_OPTIONAL,
                                      'type' => WS_TYPE_INT | WS_TYPE_POSITIVE],
          'expand' =>           ['flags' => WS_PARAM_OPTIONAL,
                                      'type' => WS_TYPE_BOOL],
          'show_nb_comments' => ['flags' => WS_PARAM_OPTIONAL,
                                      'type' => WS_TYPE_BOOL],
          'show_nb_hits' =>     ['flags' => WS_PARAM_OPTIONAL,
                                      'type' => WS_TYPE_BOOL],
          'enabled_high' =>     ['flags' => WS_PARAM_OPTIONAL,
                                      'type' => WS_TYPE_BOOL],
          'pwg_token' => [],
          ],
...
<br>set "group_id" to -1 if you want to dissociate users from all groups',
    ...
    $service->addMethod(
        ...
        'show_nb_hits' =>     ['flags' => WS_PARAM_OPTIONAL,
                                    'type' => WS_TYPE_BOOL],
        'password' =>         ['flags' => WS_PARAM_OPTIONAL],
        'new_password' =>         ['flags' => WS_PARAM_OPTIONAL],
        'conf_new_password' =>         ['flags' => WS_PARAM_OPTIONAL],
        'pwg_token' => [],
    ],
        '',
        $ws_functions_root . 'pwg.users.php',
        ['admin_only' => false, 'post_only' => true]
    );
    ...
    $service->addMethod(
        ...
        [
          'cat_id' =>     ['flags' => WS_PARAM_FORCE_ARRAY | WS_PARAM_OPTIONAL,
                                'type' => WS_TYPE_ID],
          'group_id' =>   ['flags' => WS_PARAM_FORCE_ARRAY | WS_PARAM_OPTIONAL,
                                'type' => WS_TYPE_ID],
          'user_id' =>    ['flags' => WS_PARAM_FORCE_ARRAY | WS_PARAM_OPTIONAL,
                                'type' => WS_TYPE_ID],
          ],
...
<br>Provide only one parameter!',
    ...
    $service->addMethod(
        ...
        'ws_permissions_add',
        [
          'cat_id' =>     ['flags' => WS_PARAM_FORCE_ARRAY,
                                'type' => WS_TYPE_ID],
          'group_id' =>   ['flags' => WS_PARAM_FORCE_ARRAY | WS_PARAM_OPTIONAL,
                                'type' => WS_TYPE_ID],
          'user_id' =>    ['flags' => WS_PARAM_FORCE_ARRAY | WS_PARAM_OPTIONAL,
    ...
    $service->addMethod(
        ...
        [
          'param' => [],
          'value' => ['flags' => WS_PARAM_OPTIONAL],
          'is_json' =>  ['default' => false, 'type' => WS_TYPE_BOOL],
        ],
    ...
    $service->addMethod(
        ...
        'tags_string' => ['default' => null],
        'is_download' => ['default' => false, 'type' => WS_TYPE_BOOL],
        ],
    ...
    $service->addMethod(
        ...
        'per_page' => [
          'default' => \Piwigo\Core\Config::commentsPageNbComments(),
          'type' => WS_TYPE_INT | WS_TYPE_POSITIVE,
        ],
      ],
        'Get comments',
